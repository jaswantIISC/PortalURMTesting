...
/**
 * <p>Java class for deviceAirPurifierAnnc complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="deviceAirPurifierAnnc">
 *   &lt;complexContent>
 ...
 *             &lt;element ref="{http://www.onem2m.org/xml/protocols/homedomain}airPurifierJobMode"/>
 *             &lt;element ref="{http://www.onem2m.org/xml/protocols/homedomain}airPurifierJobModeAnnc"/>
 *             &lt;element ref="{http://www.onem2m.org/xml/protocols/homedomain}airPurifierOperationMode"/>
 *             &lt;element ref="{http://www.onem2m.org/xml/protocols/homedomain}airPurifierOperationModeAnnc"/>
...
@XmlType(name = "deviceAirPurifierAnnc", propOrder = {
    "childResource",
    "binarySwitchOrBinarySwitchAnncOrRunState"
})
public class DeviceAirPurifierAnnc
    extends AnnouncedFlexContainerResource
{
    ...
    @XmlElements({
        ...
        @XmlElement(name = "airPurifierJobMode", namespace = "http://www.onem2m.org/xml/protocols/homedomain", type = AirPurifierJobMode.class),
        @XmlElement(name = "airPurifierJobModeAnnc", namespace = "http://www.onem2m.org/xml/protocols/homedomain", type = AirPurifierJobModeAnnc.class),
        @XmlElement(name = "airPurifierOperationMode", namespace = "http://www.onem2m.org/xml/protocols/homedomain", type = OperationMode.class),
        @XmlElement(name = "airPurifierOperationModeAnnc", namespace = "http://www.onem2m.org/xml/protocols/homedomain", type = OperationModeAnnc.class),
        ...
        @XmlElement(name = "filterInfo", namespace = "http://www.onem2m.org/xml/protocols/homedomain", type = FilterInfo.class),
        @XmlElement(name = "filterInfoAnnc", namespace = "http://www.onem2m.org/xml/protocols/homedomain", type = FilterInfoAnnc.class),
     ...
     * {@link RunState }
     * {@link RunStateAnnc }
     * {@link AirPurifierJobMode }
     * {@link AirPurifierJobModeAnnc }
     * {@link OperationMode }
