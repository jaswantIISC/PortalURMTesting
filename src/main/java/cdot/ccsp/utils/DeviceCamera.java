...
/**
 * <p>Java class for deviceCamera complex type.
 * 
...
@XmlType(name = "deviceCamera", propOrder = {
    "childResource",
    "sessionDescriptionOrPlayerControlOrMotionSensor"
})
    ...
    extends FlexContainerResource
{
    ...
    protected List<Object> sessionDescriptionOrPlayerControlOrMotionSensor;
    ...
    /**
     * Gets the value of the sessionDescriptionOrPlayerControlOrMotionSensor property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the sessionDescriptionOrPlayerControlOrMotionSensor property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSessionDescriptionOrPlayerControlOrMotionSensor().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getSessionDescriptionOrPlayerControlOrMotionSensor() {
        if (sessionDescriptionOrPlayerControlOrMotionSensor == null) {
            sessionDescriptionOrPlayerControlOrMotionSensor = new ArrayList<Object>();
        }
        return this.sessionDescriptionOrPlayerControlOrMotionSensor;
    }
