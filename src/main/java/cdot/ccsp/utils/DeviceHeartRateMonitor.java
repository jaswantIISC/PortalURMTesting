...
/**
 * <p>Java class for deviceHeartRateMonitor complex type.
 * 
...
@XmlType(name = "deviceHeartRateMonitor", propOrder = {
    "childResource",
    "pulsemeterOrBatteryOrSubscription"
})
public class DeviceHeartRateMonitor
    extends FlexContainerResource
{
    ...
    protected List<Object> pulsemeterOrBatteryOrSubscription;
    ...
    /**
     * Gets the value of the pulsemeterOrBatteryOrSubscription property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the pulsemeterOrBatteryOrSubscription property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPulsemeterOrBatteryOrSubscription().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getPulsemeterOrBatteryOrSubscription() {
        if (pulsemeterOrBatteryOrSubscription == null) {
            pulsemeterOrBatteryOrSubscription = new ArrayList<Object>();
        }
        return this.pulsemeterOrBatteryOrSubscription;
    }
