...
/**
 * <p>Java class for deviceHeartRateMonitorAnnc complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="deviceHeartRateMonitorAnnc">
 *   &lt;complexContent>
...
@XmlType(name = "deviceHeartRateMonitorAnnc", propOrder = {
    "childResource",
    "pulsemeterOrPulsemeterAnncOrBattery"
})
public class DeviceHeartRateMonitorAnnc
    extends AnnouncedFlexContainerResource
{
    ...
    protected List<Object> pulsemeterOrPulsemeterAnncOrBattery;
    ...
    /**
     * Gets the value of the pulsemeterOrPulsemeterAnncOrBattery property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the pulsemeterOrPulsemeterAnncOrBattery property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPulsemeterOrPulsemeterAnncOrBattery().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getPulsemeterOrPulsemeterAnncOrBattery() {
        if (pulsemeterOrPulsemeterAnncOrBattery == null) {
            pulsemeterOrPulsemeterAnncOrBattery = new ArrayList<Object>();
        }
        return this.pulsemeterOrPulsemeterAnncOrBattery;
    }
