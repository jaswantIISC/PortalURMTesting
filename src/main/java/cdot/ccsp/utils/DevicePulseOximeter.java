...
/**
 * <p>Java class for devicePulseOximeter complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="devicePulseOximeter">
 *   &lt;complexContent>
...
@XmlType(name = "devicePulseOximeter", propOrder = {
    "childResource",
    "pulsemeterOrOximeterOrBattery"
})
public class DevicePulseOximeter
    extends FlexContainerResource
{
    ...
    protected List<Object> pulsemeterOrOximeterOrBattery;
    ...
    /**
     * Gets the value of the pulsemeterOrOximeterOrBattery property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the pulsemeterOrOximeterOrBattery property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPulsemeterOrOximeterOrBattery().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getPulsemeterOrOximeterOrBattery() {
        if (pulsemeterOrOximeterOrBattery == null) {
            pulsemeterOrOximeterOrBattery = new ArrayList<Object>();
        }
        return this.pulsemeterOrOximeterOrBattery;
    }
