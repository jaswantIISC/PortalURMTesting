...
/**
 * <p>Java class for deviceTelevision complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="deviceTelevision">
 *   &lt;complexContent>
...
@XmlType(name = "deviceTelevision", propOrder = {
    "childResource",
    "binarySwitchOrAudioVolumeOrTelevisionChannel"
})
public class DeviceTelevision
    extends FlexContainerResource
{
    ...
    protected List<JAXBElement<?>> binarySwitchOrAudioVolumeOrTelevisionChannel;
    ...
    /**
     * Gets the value of the binarySwitchOrAudioVolumeOrTelevisionChannel property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the binarySwitchOrAudioVolumeOrTelevisionChannel property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBinarySwitchOrAudioVolumeOrTelevisionChannel().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<JAXBElement<?>> getBinarySwitchOrAudioVolumeOrTelevisionChannel() {
        if (binarySwitchOrAudioVolumeOrTelevisionChannel == null) {
            binarySwitchOrAudioVolumeOrTelevisionChannel = new ArrayList<JAXBElement<?>>();
        }
        return this.binarySwitchOrAudioVolumeOrTelevisionChannel;
    }
