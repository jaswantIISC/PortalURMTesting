...
/**
 * <p>Java class for deviceThermometerAnnc complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="deviceThermometerAnnc">
 *   &lt;complexContent>
...
@XmlType(name = "deviceThermometerAnnc", propOrder = {
    "childResource",
    "temperatureOrTemperatureAnncOrBattery"
})
public class DeviceThermometerAnnc
    extends AnnouncedFlexContainerResource
{
    ...
    protected List<Object> temperatureOrTemperatureAnncOrBattery;
    ...
    /**
     * Gets the value of the temperatureOrTemperatureAnncOrBattery property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the temperatureOrTemperatureAnncOrBattery property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getTemperatureOrTemperatureAnncOrBattery().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getTemperatureOrTemperatureAnncOrBattery() {
        if (temperatureOrTemperatureAnncOrBattery == null) {
            temperatureOrTemperatureAnncOrBattery = new ArrayList<Object>();
        }
        return this.temperatureOrTemperatureAnncOrBattery;
    }
