...
/**
 * <p>Java class for deviceThermostatAnnc complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="deviceThermostatAnnc">
 *   &lt;complexContent>
...
@XmlType(name = "deviceThermostatAnnc", propOrder = {
    "childResource",
    "runStateOrRunStateAnncOrTimer"
})
public class DeviceThermostatAnnc
    extends AnnouncedFlexContainerResource
{
    ...
    protected List<Object> runStateOrRunStateAnncOrTimer;
    ...
    /**
     * Gets the value of the runStateOrRunStateAnncOrTimer property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the runStateOrRunStateAnncOrTimer property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRunStateOrRunStateAnncOrTimer().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getRunStateOrRunStateAnncOrTimer() {
        if (runStateOrRunStateAnncOrTimer == null) {
            runStateOrRunStateAnncOrTimer = new ArrayList<Object>();
        }
        return this.runStateOrRunStateAnncOrTimer;
    }
