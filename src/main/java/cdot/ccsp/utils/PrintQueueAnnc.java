...
/**
 * <p>Java class for printQueueAnnc complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="printQueueAnnc">
 *   &lt;complexContent>
 ...
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="printingState" minOccurs="0">
 *           &lt;simpleType>
...
@XmlType(name = "printQueueAnnc", propOrder = {
    "uri",
    "printingState",
    "childResource",
    "subscription"
})
public class PrintQueueAnnc
    extends AnnouncedFlexContainerResource
{
    ...
    @XmlList
    protected List<BigInteger> printingState;
    ...
    /**
     * Gets the value of the printingState property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the printingState property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPrintingState().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<BigInteger> getPrintingState() {
        if (printingState == null) {
            printingState = new ArrayList<BigInteger>();
        }
