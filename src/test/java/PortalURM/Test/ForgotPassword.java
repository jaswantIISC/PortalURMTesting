...
public class ForgotPassword extends WebDriverSetup{
	...
	String emailAccountId = "jmeena@cdot.in";	
	String emailAccountPassword = "csaJaswant.13";
	String passwordToSet = "cdot@123";
	
	@Test
	public void testDriver() throws InterruptedException {
		System.out.println("[ForgotPassword.java][testDriver()]: ");
		portalCommands.forgotPassword(driver, passwordToSet, emailAccountId, emailAccountPassword);	
	}
