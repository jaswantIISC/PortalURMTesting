...
@Tag("TP_oneM2M_CSE_DMR_CRE_004")
public class TP_oneM2M_CSE_DMR_CRE_004 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_CRE_004_CNT")
	void TP_oneM2M_CSE_DMR_CRE_004_CNT() {
		...
		OneM2MResponse container1Response = contCreate.createWithResourceName(resourceName, TestingParams.GENERAL_ADN_AE_ID, TestingParams.ADMIN_AE_ID, TestingParams.getSecurityParams(TestingParams.ADMIN_AE_ID));
		assertEquals(M2MStatus.ACCESS_DENIED.getOnem2mStatusCode(), container1Response.getResponseStatusCode());
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_CRE_004_ACP")
	void TP_oneM2M_CSE_DMR_CRE_004_ACP() {
		...
		OneM2MResponse acpResponse = acpCreate.createWithAllPrivilegeAndResourceName(resourceName, TestingParams.GENERAL_ADN_AE_ID, TestingParams.ADMIN_AE_ID, TestingParams.getSecurityParams(TestingParams.ADMIN_AE_ID));
		assertEquals(M2MStatus.ACCESS_DENIED.getOnem2mStatusCode(), acpResponse.getResponseStatusCode());
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_CRE_004_SUB")
	void TP_oneM2M_CSE_DMR_CRE_004_SUB() {
		...
		OneM2MResponse subResponse = subCreate.subWithResourceName(resourceName, TestingParams.GENERAL_ADN_AE_ID, TestingParams.ADMIN_AE_ID, TestingParams.getSecurityParams(TestingParams.ADMIN_AE_ID));
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_CRE_004_GRP")
	void TP_oneM2M_CSE_DMR_CRE_004_GRP() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		...
		OneM2MResponse groupCreateResponse = grpCreate.createGroupWithResourceName(resourceName, TestingParams.GENERAL_ADN_AE_ID, TestingParams.ADMIN_AE_ID, TestingParams.getSecurityParams(TestingParams.ADMIN_AE_ID), Arrays.asList(container1StructuredResourceId));
		assertEquals(M2MStatus.ACCESS_DENIED.getOnem2mStatusCode(), groupCreateResponse.getResponseStatusCode());
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_CRE_004_PCH")
	void TP_oneM2M_CSE_DMR_CRE_004_PCH() {
		...
		// CONTAINER CREATE 1
		OneM2MResponse pollingChannelResponse = pcCreate.createWithResourceName(resourceName, TestingParams.GENERAL_ADN_AE_ID, TestingParams.ADMIN_AE_ID, TestingParams.getSecurityParams(TestingParams.ADMIN_AE_ID));
		assertEquals(M2MStatus.ACCESS_DENIED.getOnem2mStatusCode(), pollingChannelResponse.getResponseStatusCode());
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_CRE_004_TS")
	void TP_oneM2M_CSE_DMR_CRE_004_TS() {
		...
		// CONTAINER CREATE 1
		OneM2MResponse tsCreateResponse = tsCreate.createWithResourceName(resourceName, TestingParams.GENERAL_ADN_AE_ID, TestingParams.ADMIN_AE_ID, TestingParams.getSecurityParams(TestingParams.ADMIN_AE_ID));
		assertEquals(M2MStatus.ACCESS_DENIED.getOnem2mStatusCode(), tsCreateResponse.getResponseStatusCode());
		// CONTAINER UPDATE ENDS
