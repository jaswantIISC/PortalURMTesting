...
@Tag("TP_oneM2M_CSE_DMR_CRE_005")
public class TP_oneM2M_CSE_DMR_CRE_005 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_CRE_005_MNI")
	void TP_oneM2M_CSE_DMR_CRE_005_MNI() {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_CRE_005_MBS")
	void TP_oneM2M_CSE_DMR_CRE_005_MBS() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		OneM2MResponse container1Response = contCreate.createWithMaxByteSize(BigInteger.valueOf(-1), TestingParams.GENERAL_ADN_AE_ID, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.BAD_REQUEST.getOnem2mStatusCode(), container1Response.getResponseStatusCode());
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_CRE_005_MIA")
	void TP_oneM2M_CSE_DMR_CRE_005_MIA() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		OneM2MResponse container1Response = contCreate.createWithMaxInstanceAge(BigInteger.valueOf(-1), TestingParams.GENERAL_ADN_AE_ID, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.BAD_REQUEST.getOnem2mStatusCode(), container1Response.getResponseStatusCode());
