...
@Tag("TP_oneM2M_CSE_DMR_CRE_006")
public class TP_oneM2M_CSE_DMR_CRE_006 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_CRE_006_CNT_MNI")
	void TP_oneM2M_CSE_DMR_CRE_006_CNT_MNI() {
		...
		assertNotNull(cont.getMaxNrOfInstances());
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_CRE_006_CNT_MBS")
	void TP_oneM2M_CSE_DMR_CRE_006_CNT_MBS() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		container1ResourceId = cont.getResourceID();
		container1StructuredResourceId = aeStructuredResourceID + "/" + cont.getResourceName();
		assertNotNull(cont.getMaxByteSize());
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_CRE_006_CNT_MIA")
	void TP_oneM2M_CSE_DMR_CRE_006_CNT_MIA() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		container1ResourceId = cont.getResourceID();
		container1StructuredResourceId = aeStructuredResourceID + "/" + cont.getResourceName();
		assertNotNull(cont.getMaxInstanceAge());
		// INITIAL STATE ENDS
		// CONTAINER UPDATE ENDS
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_CRE_006_TS_MNI")
	void TP_oneM2M_CSE_DMR_CRE_006_TS_MNI() {
		...
		OneM2MResponse container1Response = tsCreate.createWithAnyAttribute(TestingParams.GENERAL_ADN_AE_ID, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.CREATED.getOnem2mStatusCode(), container1Response.getResponseStatusCode());
		// CONTAINER CREATE 1 ENDS
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_CRE_006_TS_MBS")
	void TP_oneM2M_CSE_DMR_CRE_006_TS_MBS() {
		TimeSeriesCreateTestCases tsCreate = new TimeSeriesCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_CRE_006_TS_MIA")
	void TP_oneM2M_CSE_DMR_CRE_006_TS_MIA() {
		TimeSeriesCreateTestCases tsCreate = new TimeSeriesCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
