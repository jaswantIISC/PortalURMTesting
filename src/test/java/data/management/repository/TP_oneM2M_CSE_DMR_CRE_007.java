...
@Tag("TP_oneM2M_CSE_DMR_CRE_007")
public class TP_oneM2M_CSE_DMR_CRE_007 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_CRE_007_CNT_CIN")
	void TP_oneM2M_CSE_DMR_CRE_007_CNT_CNI() {
		...
		OneM2MResponse container1Response = contCreate.createWithMaxNumberOfInstance(BigInteger.valueOf(1), TestingParams.GENERAL_ADN_AE_ID, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		...
		assertEquals(BigInteger.valueOf(1), cont.getMaxNrOfInstances());
		assertEquals(BigInteger.valueOf(0), cont.getCurrentNrOfInstances());
		
		container1Response = ciCreate.createWithAnyAttribute(container1StructuredResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.CREATED.getOnem2mStatusCode(), container1Response.getResponseStatusCode());
		...
		assertEquals(BigInteger.valueOf(1), cont.getCurrentNrOfInstances());

		container1Response = ciCreate.createWithAnyAttribute(container1StructuredResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.CREATED.getOnem2mStatusCode(), container1Response.getResponseStatusCode());
		ci = (ContentInstance) container1Response.getPrimitiveContent().getAny();
		String newerCIResourceId = ci.getResourceID();
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_CRE_007_TS_MNI")
	void TP_oneM2M_CSE_DMR_CRE_007_TS_MNI() {
		...
		OneM2MResponse container1Response = tsCreate.createWithMaxNumberOfInstances(BigInteger.valueOf(1), TestingParams.GENERAL_ADN_AE_ID, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.CREATED.getOnem2mStatusCode(), container1Response.getResponseStatusCode());
		// CONTAINER CREATE 1 ENDS
		...
		container1Response = tsiCreate.createWithAnyAttribute(container1StructuredResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.CREATED.getOnem2mStatusCode(), container1Response.getResponseStatusCode());
