...
@Tag("TP_oneM2M_CSE_DMR_CRE_009")
public class TP_oneM2M_CSE_DMR_CRE_009 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_CRE_009_CNT")
	void TP_oneM2M_CSE_DMR_CRE_009_CNT() {
		...
		assertEquals(ci.getStateTag(), cont.getStateTag().add(BigInteger.valueOf(1)));
		...
		assertEquals(cont.getStateTag(), ci.getStateTag());
