...
@Tag("TP_oneM2M_CSE_DMR_CRE_010")
public class TP_oneM2M_CSE_DMR_CRE_010 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_CRE_010_CNT")
	void TP_oneM2M_CSE_DMR_CRE_010_CNT() {
		...
		container1Response = contCreate.createWithResourceName("la", container1ResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
