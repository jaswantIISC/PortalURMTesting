...
@Tag("TP_oneM2M_CSE_DMR_CRE_011")
public class TP_oneM2M_CSE_DMR_CRE_011 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_CRE_011_CNT")
	void TP_oneM2M_CSE_DMR_CRE_011_CNT() {
		...
		container1Response = contCreate.createWithResourceName("ol", container1ResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.OPERATION_NOT_ALLOWED.getOnem2mStatusCode(), container1Response.getResponseStatusCode());
