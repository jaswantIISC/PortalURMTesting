...
@Tag("TP_oneM2M_CSE_DMR_CRE_013")
public class TP_oneM2M_CSE_DMR_CRE_013 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_CRE_013_CNT_CNI")
	void TP_oneM2M_CSE_DMR_CRE_013_CNT_CNI() {
		...
		OneM2MResponse container1Response = contCreate.createWithMaxByteSize(BigInteger.valueOf(10), TestingParams.GENERAL_ADN_AE_ID, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		...
		assertEquals(BigInteger.valueOf(10), cont.getMaxByteSize());
		...
		assertEquals(M2MStatus.NOT_ACCEPTABLE.getOnem2mStatusCode(), ciResponse.getResponseStatusCode());
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_CRE_013_TS_TSI")
	void TP_oneM2M_CSE_DMR_CRE_013_TS_TSI() {
		...
		OneM2MResponse container1Response = tsCreate.createWithMaxByteSize(BigInteger.valueOf(10), TestingParams.GENERAL_ADN_AE_ID, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.CREATED.getOnem2mStatusCode(), container1Response.getResponseStatusCode());
		// CONTAINER CREATE 1 ENDS
		...
		assertEquals(BigInteger.valueOf(10), ts.getMaxByteSize());
		assertEquals(BigInteger.valueOf(0), ts.getCurrentNrOfInstances());
		//assertEquals(ts.getStateTag(), BigInteger.valueOf(0));

		OneM2MResponse ciResponse = tsiCreate.createWithContentValue("SomeThingBiggerThanMaxByteSizeHopingItWouldBeEnough", container1ResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.NOT_ACCEPTABLE.getOnem2mStatusCode(), ciResponse.getResponseStatusCode());
