...
@Tag("TP_oneM2M_CSE_DMR_CRE_015")
public class TP_oneM2M_CSE_DMR_CRE_015 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_CRE_015_CNT")
	void TP_oneM2M_CSE_DMR_CRE_015_CNT() {
		...
		OneM2MResponse container1Response = contCreate.createWithResultContent(BigInteger.valueOf(0), TestingParams.GENERAL_ADN_AE_ID, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.CREATED.getOnem2mStatusCode(), container1Response.getResponseStatusCode());
		// CONTAINER CREATE 1 ENDS
		assertNull(container1Response.getPrimitiveContent());
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_CRE_015_GRP")
	void TP_oneM2M_CSE_DMR_CRE_015_GRP() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		OneM2MResponse grpResponse = grpCreate.createWithResultContent(BigInteger.valueOf(0), memberIds, TestingParams.GENERAL_ADN_AE_ID, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.CREATED.getOnem2mStatusCode(), grpResponse.getResponseStatusCode());
		assertNull(grpResponse.getPrimitiveContent());
		// INITIAL STATE ENDS
		// CONTAINER UPDATE ENDS
		// TEST EVENT ENDS
		System.out.println(" AE-ID : " + aeId);
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_CRE_015_ACP")
	void TP_oneM2M_CSE_DMR_CRE_015_ACP() {
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		OneM2MResponse acpResponse = acpCreate.createWithAllPrivilegeAndResultContent(BigInteger.valueOf(0), TestingParams.GENERAL_ADN_AE_ID, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.CREATED.getOnem2mStatusCode(), acpResponse.getResponseStatusCode());
		assertNull(acpResponse.getPrimitiveContent());
		// INITIAL STATE ENDS
		// CONTAINER UPDATE ENDS
		// TEST EVENT ENDS
		System.out.println(" AE-ID : " + aeId);
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_CRE_015_SUB")
	void TP_oneM2M_CSE_DMR_CRE_015_SUB() {
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		OneM2MResponse subResponse = subCreate.createWithResultContent(BigInteger.valueOf(0), TestingParams.GENERAL_ADN_AE_ID, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.CREATED.getOnem2mStatusCode(), subResponse.getResponseStatusCode());
		assertNull(subResponse.getPrimitiveContent());
		// INITIAL STATE ENDS
		// CONTAINER UPDATE ENDS
		// TEST EVENT ENDS
		System.out.println(" AE-ID : " + aeId);
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_CRE_015_PCH")
	void TP_oneM2M_CSE_DMR_CRE_015_PCH() {
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		OneM2MResponse pchResponse = pchCreate.createWithResultContent(BigInteger.valueOf(0), TestingParams.GENERAL_ADN_AE_ID, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.CREATED.getOnem2mStatusCode(), pchResponse.getResponseStatusCode());
		assertNull(pchResponse.getPrimitiveContent());
		// INITIAL STATE ENDS
		// CONTAINER UPDATE ENDS
		// TEST EVENT ENDS
		System.out.println(" AE-ID : " + aeId);
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_CRE_015_TS")
	void TP_oneM2M_CSE_DMR_CRE_015_TS() {
		...
		OneM2MResponse tsResponse = tsCreate.createWithResultContent(BigInteger.valueOf(0), TestingParams.GENERAL_ADN_AE_ID, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.CREATED.getOnem2mStatusCode(), tsResponse.getResponseStatusCode());
		// CONTAINER CREATE 1 ENDS
		assertNull(tsResponse.getPrimitiveContent());
