...
@Tag("TP_oneM2M_CSE_DMR_CRE_016")
public class TP_oneM2M_CSE_DMR_CRE_016 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_CRE_016_CNT")
	void TP_oneM2M_CSE_DMR_CRE_016_CNT() {
		...
		OneM2MResponse container1Response = contCreate.createWithResultContent(BigInteger.valueOf(2), TestingParams.GENERAL_ADN_AE_ID, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.CREATED.getOnem2mStatusCode(), container1Response.getResponseStatusCode());
		// CONTAINER CREATE 1 ENDS
		assertThat(container1Response.getPrimitiveContent().getAny(), instanceOf(String.class));
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_CRE_016_GRP")
	void TP_oneM2M_CSE_DMR_CRE_016_GRP() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		OneM2MResponse grpResponse = grpCreate.createWithResultContent(BigInteger.valueOf(2), memberIds, TestingParams.GENERAL_ADN_AE_ID, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.CREATED.getOnem2mStatusCode(), grpResponse.getResponseStatusCode());
		assertTrue(grpResponse.getPrimitiveContent().getAny() instanceof String);
		// INITIAL STATE ENDS
		// CONTAINER UPDATE ENDS
		// TEST EVENT ENDS
		System.out.println(" AE-ID : " + aeId);
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_CRE_016_ACP")
	void TP_oneM2M_CSE_DMR_CRE_016_ACP() {
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		OneM2MResponse acpResponse = acpCreate.createWithAllPrivilegeAndResultContent(BigInteger.valueOf(2), TestingParams.GENERAL_ADN_AE_ID, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.CREATED.getOnem2mStatusCode(), acpResponse.getResponseStatusCode());
		assertTrue(acpResponse.getPrimitiveContent().getAny() instanceof String);
		// INITIAL STATE ENDS
		// CONTAINER UPDATE ENDS
		// TEST EVENT ENDS
		System.out.println(" AE-ID : " + aeId);
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_CRE_016_SUB")
	void TP_oneM2M_CSE_DMR_CRE_016_SUB() {
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		OneM2MResponse subResponse = subCreate.createWithResultContent(BigInteger.valueOf(2), TestingParams.GENERAL_ADN_AE_ID, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.CREATED.getOnem2mStatusCode(), subResponse.getResponseStatusCode());
		assertTrue(subResponse.getPrimitiveContent().getAny() instanceof String);
		// INITIAL STATE ENDS
		// CONTAINER UPDATE ENDS
		// TEST EVENT ENDS
		System.out.println(" AE-ID : " + aeId);
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_CRE_016_PCH")
	void TP_oneM2M_CSE_DMR_CRE_016_PCH() {
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		OneM2MResponse pchResponse = pchCreate.createWithResultContent(BigInteger.valueOf(2), TestingParams.GENERAL_ADN_AE_ID, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.CREATED.getOnem2mStatusCode(), pchResponse.getResponseStatusCode());
		assertTrue(pchResponse.getPrimitiveContent().getAny() instanceof String);
		// INITIAL STATE ENDS
		// CONTAINER UPDATE ENDS
		// TEST EVENT ENDS
		System.out.println(" AE-ID : " + aeId);
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_CRE_016_TS")
	void TP_oneM2M_CSE_DMR_CRE_016_TS() {
		...
		OneM2MResponse tsResponse = tsCreate.createWithResultContent(BigInteger.valueOf(2), TestingParams.GENERAL_ADN_AE_ID, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.CREATED.getOnem2mStatusCode(), tsResponse.getResponseStatusCode());
		// CONTAINER CREATE 1 ENDS
		assertTrue(tsResponse.getPrimitiveContent().getAny() instanceof String);
