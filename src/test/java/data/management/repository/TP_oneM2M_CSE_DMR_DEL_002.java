...
@Tag("TP_oneM2M_CSE_DMR_DEL_002")
public class TP_oneM2M_CSE_DMR_DEL_002 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_DEL_002_CNT")
	void TP_oneM2M_CSE_DMR_DEL_002_CNT() {
		...
		OneM2MResponse delResponse = genDelete.deleteResource(cont.getResourceID(), TestingParams.ADMIN_AE_ID, TestingParams.getSecurityParams(TestingParams.ADMIN_AE_ID));
		assertEquals(M2MStatus.ACCESS_DENIED.getOnem2mStatusCode(), delResponse.getResponseStatusCode());
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_DEL_002_ACP")
	void TP_oneM2M_CSE_DMR_DEL_002_ACP() {
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		OneM2MResponse acpResponse = acpCreate.createWithLimitedOperationPrivSelfPriv(TestingParams.GENERAL_ADN_AE_ID, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		...
		OneM2MResponse delResponse = genDelete.deleteResource(acp.getResourceID(), TestingParams.ADMIN_AE_ID, TestingParams.getSecurityParams(TestingParams.ADMIN_AE_ID));
		assertEquals(M2MStatus.ACCESS_DENIED.getOnem2mStatusCode(), delResponse.getResponseStatusCode());
		// INITIAL STATE ENDS
		// CONTAINER UPDATE ENDS
		// TEST EVENT ENDS
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_DEL_002_SUB")
	void TP_oneM2M_CSE_DMR_DEL_002_SUB() {
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		OneM2MResponse delResponse = genDelete.deleteResource(sub.getResourceID(), TestingParams.ADMIN_AE_ID, TestingParams.getSecurityParams(TestingParams.ADMIN_AE_ID));
		assertEquals(M2MStatus.ACCESS_DENIED.getOnem2mStatusCode(), delResponse.getResponseStatusCode());
		// INITIAL STATE ENDS
		// CONTAINER UPDATE ENDS
		// TEST EVENT ENDS
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_DEL_002_GRP")
	void TP_oneM2M_CSE_DMR_DEL_002_GRP() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		OneM2MResponse delResponse = genDelete.deleteResource(grp.getResourceID(), TestingParams.ADMIN_AE_ID, TestingParams.getSecurityParams(TestingParams.ADMIN_AE_ID));
		assertEquals(M2MStatus.ACCESS_DENIED.getOnem2mStatusCode(), delResponse.getResponseStatusCode());
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_DEL_002_TS")
	void TP_oneM2M_CSE_DMR_DEL_002_TS() {
		...
		OneM2MResponse delResponse = genDelete.deleteResource(ts.getResourceID(), TestingParams.ADMIN_AE_ID, TestingParams.getSecurityParams(TestingParams.ADMIN_AE_ID));
		assertEquals(M2MStatus.ACCESS_DENIED.getOnem2mStatusCode(), delResponse.getResponseStatusCode());
