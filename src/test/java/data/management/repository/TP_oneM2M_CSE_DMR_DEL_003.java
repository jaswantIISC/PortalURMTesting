...
@Tag("TP_oneM2M_CSE_DMR_DEL_003")
public class TP_oneM2M_CSE_DMR_DEL_003 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_DEL_003_CNT")
	void TP_oneM2M_CSE_DMR_DEL_003_CNT() {
		...
		String randomResourceId = "R" + Math.random();
		
		OneM2MResponse delResponse = genDelete.deleteResource(randomResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
