...
@Tag("TP_oneM2M_CSE_DMR_DEL_004")
public class TP_oneM2M_CSE_DMR_DEL_004 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_DEL_004_CNT")
	void TP_oneM2M_CSE_DMR_DEL_004_CNT() {
		...
		delResponse = genDelete.deleteResource(cont.getResourceID(), TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.NOT_FOUND.getOnem2mStatusCode(), delResponse.getResponseStatusCode());
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_DEL_004_ACP")
	void TP_oneM2M_CSE_DMR_DEL_004_ACP() {
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		delResponse = genDelete.deleteResource(acp.getResourceID(), TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.NOT_FOUND.getOnem2mStatusCode(), delResponse.getResponseStatusCode());
		// INITIAL STATE ENDS
		// CONTAINER UPDATE ENDS
		// TEST EVENT ENDS
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_DEL_004_SUB")
	void TP_oneM2M_CSE_DMR_DEL_004_SUB() {
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		delResponse = genDelete.deleteResource(sub.getResourceID(), TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.NOT_FOUND.getOnem2mStatusCode(), delResponse.getResponseStatusCode());
		// INITIAL STATE ENDS
		// CONTAINER UPDATE ENDS
		// TEST EVENT ENDS
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_DEL_004_GRP")
	void TP_oneM2M_CSE_DMR_DEL_004_GRP() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		delResponse = genDelete.deleteResource(grp.getResourceID(), TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.NOT_FOUND.getOnem2mStatusCode(), delResponse.getResponseStatusCode());
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_DEL_004_STCG")
	void TP_oneM2M_CSE_DMR_DEL_004_STCG() {
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		delResponse = genDelete.deleteResource(sc.getResourceID(), TestingParams.ADMIN_AE_ID, TestingParams.getSecurityParams(TestingParams.ADMIN_AE_ID));
		assertEquals(M2MStatus.NOT_FOUND.getOnem2mStatusCode(), delResponse.getResponseStatusCode());
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_DEL_004_TS")
	void TP_oneM2M_CSE_DMR_DEL_004_TS() {
		...
		delResponse = genDelete.deleteResource(ts.getResourceID(), TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.NOT_FOUND.getOnem2mStatusCode(), delResponse.getResponseStatusCode());
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_DEL_004_TSI")
	void TP_oneM2M_CSE_DMR_DEL_004_TSI() {
		TimeSeriesCreateTestCases tsCreate = new TimeSeriesCreateTestCases();
