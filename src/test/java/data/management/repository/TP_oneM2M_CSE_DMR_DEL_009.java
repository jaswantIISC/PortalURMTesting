...
@Tag("TP_oneM2M_CSE_DMR_DEL_009")
public class TP_oneM2M_CSE_DMR_DEL_009 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_DEL_009")
	void TP_oneM2M_CSE_DMR_DEL_009_CNT() {
		...
		OneM2MResponse delResponse = genDelete.deleteResource(cont.getResourceID() + "/ol", TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.DELETED.getOnem2mStatusCode(), delResponse.getResponseStatusCode());

		container1Response = genRetrieve.retrieveResource(ciOldested.getResourceID(), TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
