...
@Tag("TP_oneM2M_CSE_DMR_DEL_011")
public class TP_oneM2M_CSE_DMR_DEL_011 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_DEL_011_RCN_2")
	void TP_oneM2M_CSE_DMR_DEL_011_RCN_2() {
		...
		OneM2MResponse delResponse = genDelete.deleteResourceWithResultContent(BigInteger.valueOf(2), cont.getResourceID(), TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.BAD_REQUEST.getOnem2mStatusCode(), delResponse.getResponseStatusCode());
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_DEL_011_RCN_3")
	void TP_oneM2M_CSE_DMR_DEL_011_RCN_3() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		OneM2MResponse delResponse = genDelete.deleteResourceWithResultContent(BigInteger.valueOf(3), cont.getResourceID(), TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.BAD_REQUEST.getOnem2mStatusCode(), delResponse.getResponseStatusCode());
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_DEL_011_RCN_4")
	void TP_oneM2M_CSE_DMR_DEL_011_RCN_4() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		OneM2MResponse delResponse = genDelete.deleteResourceWithResultContent(BigInteger.valueOf(4), cont.getResourceID(), TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.BAD_REQUEST.getOnem2mStatusCode(), delResponse.getResponseStatusCode());
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_DEL_011_RCN_5")
	void TP_oneM2M_CSE_DMR_DEL_011_RCN_5() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		OneM2MResponse delResponse = genDelete.deleteResourceWithResultContent(BigInteger.valueOf(5), cont.getResourceID(), TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.BAD_REQUEST.getOnem2mStatusCode(), delResponse.getResponseStatusCode());
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_DEL_011_RCN_6")
	void TP_oneM2M_CSE_DMR_DEL_011_RCN_6() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		OneM2MResponse delResponse = genDelete.deleteResourceWithResultContent(BigInteger.valueOf(6), cont.getResourceID(), TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.BAD_REQUEST.getOnem2mStatusCode(), delResponse.getResponseStatusCode());
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_DEL_011_RCN_7")
	void TP_oneM2M_CSE_DMR_DEL_011_RCN_7() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		OneM2MResponse delResponse = genDelete.deleteResourceWithResultContent(BigInteger.valueOf(7), cont.getResourceID(), TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.BAD_REQUEST.getOnem2mStatusCode(), delResponse.getResponseStatusCode());
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_DEL_011_RCN_8")
	void TP_oneM2M_CSE_DMR_DEL_011_RCN_8() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		OneM2MResponse delResponse = genDelete.deleteResourceWithResultContent(BigInteger.valueOf(8), cont.getResourceID(), TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.BAD_REQUEST.getOnem2mStatusCode(), delResponse.getResponseStatusCode());
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_DEL_011_RCN_9")
	void TP_oneM2M_CSE_DMR_DEL_011_RCN_9() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		OneM2MResponse delResponse = genDelete.deleteResourceWithResultContent(BigInteger.valueOf(9), cont.getResourceID(), TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.BAD_REQUEST.getOnem2mStatusCode(), delResponse.getResponseStatusCode());
