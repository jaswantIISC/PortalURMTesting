...
@Tag("TP_oneM2M_CSE_DMR_DEL_012")
public class TP_oneM2M_CSE_DMR_DEL_012 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_DEL_012_CNT")
	void TP_oneM2M_CSE_DMR_DEL_012_CNT() {
		...
		OneM2MResponse delResponse = genDelete.deleteResourceWithResultContent(BigInteger.valueOf(0), cont.getResourceID(), TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.DELETED.getOnem2mStatusCode(), delResponse.getResponseStatusCode());
		assertNull(delResponse.getPrimitiveContent());
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_DEL_012_GRP")
	void TP_oneM2M_CSE_DMR_DEL_012_GRP() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		OneM2MResponse delResponse = genDelete.deleteResourceWithResultContent(BigInteger.valueOf(0), grp.getResourceID(), TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.DELETED.getOnem2mStatusCode(), delResponse.getResponseStatusCode());
		assertNull(delResponse.getPrimitiveContent());
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_DEL_012_ACP")
	void TP_oneM2M_CSE_DMR_DEL_012_ACP() {
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		OneM2MResponse delResponse = genDelete.deleteResourceWithResultContent(BigInteger.valueOf(0), acp.getResourceID(), TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.DELETED.getOnem2mStatusCode(), delResponse.getResponseStatusCode());
		assertNull(delResponse.getPrimitiveContent());
		// INITIAL STATE ENDS
		// CONTAINER UPDATE ENDS
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_DEL_012_PCH")
	void TP_oneM2M_CSE_DMR_DEL_012_PCH() {
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		OneM2MResponse delResponse = genDelete.deleteResourceWithResultContent(BigInteger.valueOf(0), pch.getResourceID(), TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.DELETED.getOnem2mStatusCode(), delResponse.getResponseStatusCode());
		assertNull(delResponse.getPrimitiveContent());
		// INITIAL STATE ENDS
		// CONTAINER UPDATE ENDS
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_DEL_012_SUB")
	void TP_oneM2M_CSE_DMR_DEL_012_SUB() {
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		OneM2MResponse delResponse = genDelete.deleteResourceWithResultContent(BigInteger.valueOf(0), sub.getResourceID(), TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.DELETED.getOnem2mStatusCode(), delResponse.getResponseStatusCode());
		assertNull(delResponse.getPrimitiveContent());
		// INITIAL STATE ENDS
		// CONTAINER UPDATE ENDS
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_DEL_012_TS")
	void TP_oneM2M_CSE_DMR_DEL_012_TS() {
		...
		OneM2MResponse delResponse = genDelete.deleteResourceWithResultContent(BigInteger.valueOf(0), ts.getResourceID(), TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.DELETED.getOnem2mStatusCode(), delResponse.getResponseStatusCode());
		assertNull(delResponse.getPrimitiveContent());
