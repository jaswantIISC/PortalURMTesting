...
@Tag("TP_oneM2M_CSE_DMR_DEL_013")
public class TP_oneM2M_CSE_DMR_DEL_013 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_DEL_013_CNT")
	void TP_oneM2M_CSE_DMR_DEL_013_CNT() {
		...
		OneM2MResponse delResponse = genDelete.deleteResourceWithResultContent(BigInteger.valueOf(1), cont.getResourceID(), TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.DELETED.getOnem2mStatusCode(), delResponse.getResponseStatusCode());
		assertTrue(delResponse.getPrimitiveContent().getAny() instanceof Container);
		assertFalse(delResponse.getPrimitiveContent().getAny() instanceof ResourceWrapper);
		cont = (Container) delResponse.getPrimitiveContent().getAny();
		assertNull(cont.getChildResource());
		assertFalse(delResponse.getPrimitiveContent().getAny() instanceof UriContent);
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_DEL_013_GRP")
	void TP_oneM2M_CSE_DMR_DEL_013_GRP() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		OneM2MResponse delResponse = genDelete.deleteResourceWithResultContent(BigInteger.valueOf(1), grp.getResourceID(), TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.DELETED.getOnem2mStatusCode(), delResponse.getResponseStatusCode());
		assertTrue(delResponse.getPrimitiveContent().getAny() instanceof Group);
		assertFalse(delResponse.getPrimitiveContent().getAny() instanceof ResourceWrapper);
		grp = (Group) delResponse.getPrimitiveContent().getAny();
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_DEL_013_ACP")
	void TP_oneM2M_CSE_DMR_DEL_013_ACP() {
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		OneM2MResponse delResponse = genDelete.deleteResourceWithResultContent(BigInteger.valueOf(1), acp.getResourceID(), TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.DELETED.getOnem2mStatusCode(), delResponse.getResponseStatusCode());
		assertTrue(delResponse.getPrimitiveContent().getAny() instanceof AccessControlPolicy);
		assertFalse(delResponse.getPrimitiveContent().getAny() instanceof ResourceWrapper);
		acp = (AccessControlPolicy) delResponse.getPrimitiveContent().getAny();
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_DEL_013_PCH")
	void TP_oneM2M_CSE_DMR_DEL_013_PCH() {
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		OneM2MResponse delResponse = genDelete.deleteResourceWithResultContent(BigInteger.valueOf(1), pch.getResourceID(), TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.DELETED.getOnem2mStatusCode(), delResponse.getResponseStatusCode());
		assertTrue(delResponse.getPrimitiveContent().getAny() instanceof PollingChannel);
		assertFalse(delResponse.getPrimitiveContent().getAny() instanceof ResourceWrapper);
		pch = (PollingChannel) delResponse.getPrimitiveContent().getAny();
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_DEL_013_SUB")
	void TP_oneM2M_CSE_DMR_DEL_013_SUB() {
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		OneM2MResponse delResponse = genDelete.deleteResourceWithResultContent(BigInteger.valueOf(1), sub.getResourceID(), TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.DELETED.getOnem2mStatusCode(), delResponse.getResponseStatusCode());
		assertTrue(delResponse.getPrimitiveContent().getAny() instanceof Subscription);
		assertFalse(delResponse.getPrimitiveContent().getAny() instanceof ResourceWrapper);
		sub = (Subscription) delResponse.getPrimitiveContent().getAny();
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_DEL_013_TS")
	void TP_oneM2M_CSE_DMR_DEL_013_TS() {
		...
		OneM2MResponse delResponse = genDelete.deleteResourceWithResultContent(BigInteger.valueOf(1), ts.getResourceID(), TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.DELETED.getOnem2mStatusCode(), delResponse.getResponseStatusCode());
		assertTrue(delResponse.getPrimitiveContent().getAny() instanceof TimeSeries);
		assertFalse(delResponse.getPrimitiveContent().getAny() instanceof ResourceWrapper);
		ts = (TimeSeries) delResponse.getPrimitiveContent().getAny();
