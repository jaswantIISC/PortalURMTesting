...
@Tag("TP_oneM2M_CSE_DMR_RET_002")
public class TP_oneM2M_CSE_DMR_RET_002 {
	...
	@Test
		@Tag("TP_oneM2M_CSE_DMR_RET_002")
		void TP_oneM2M_CSE_DMR_RET_002() {
		...
		// TEST EVENT STARTS
		// CONT RETRIEVE
			OneM2MResponse containerUpdateResponse = genRetrieve.retrieveResource("XYZ123", aeId, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
