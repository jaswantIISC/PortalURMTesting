...
@Tag("TP_oneM2M_CSE_DMR_RET_012")
public class TP_oneM2M_CSE_DMR_RET_012 {
	...
	public class NestedTestCases {
		@Test
		@Tag("TP_oneM2M_CSE_DMR_RET_012")
		void TP_oneM2M_CSE_DMR_RET_012() {
			...
			assertEquals(contentInstanceResourceId2, ci.getResourceID());
