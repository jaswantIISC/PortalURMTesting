...
import cdot.onem2m.resource.xsd.Request;
...
@Tag("TP_oneM2M_CSE_DMR_RET_013")
public class TP_oneM2M_CSE_DMR_RET_013 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_GEN_UPD_013_ACP")
	void TP_oneM2M_CSE_DMR_RET_013_ACP() {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_RET_013_AE")
	void TP_oneM2M_CSE_GEN_CRE_013_AE() {
		...
		// TEST EVENT STARTS
		// CONT RETRIEVE
		OneM2MResponse containerUpdateResponse = genRetrieve.retrieveResource(aeStructuredResourceID, aeId, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_RET_013_CNT")
	void TP_oneM2M_CSE_GEN_CRE_013_CNT() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_RET_013_SUB")
	void TP_oneM2M_CSE_DMR_RET_013_SUB() {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_RET_013_GRP")
	void TP_oneM2M_CSE_DMR_RET_013_GRP() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_RET_013_LCP")
	void TP_oneM2M_CSE_DMR_RET_013_LCP() {
		...
		container1StructuredResourceId = aeStructuredResourceID + "/" + lcp.getResourceName();
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_RET_013_NOD")
	void TP_oneM2M_CSE_DMR_RET_013_NOD() {
		...
		// TEST EVENT STARTS
		// CONT RETRIEVE
		OneM2MResponse containerUpdateResponse = genRetrieve.retrieveResource(container1StructuredResourceId, TestingParams.ADMIN_AE_ID, TestingParams.getSecurityParams(TestingParams.ADMIN_AE_ID));
		assertEquals(M2MStatus.OK.getOnem2mStatusCode(), containerUpdateResponse.getResponseStatusCode());
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_RET_013_REQ")
	void TP_oneM2M_CSE_DMR_RET_013_REQ() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
...
//		Container cont = (Container) container1Response.getPrimitiveContent().getAny();
		...
		// TEST EVENT STARTS
		// CONT RETRIEVE
		OneM2MResponse containerUpdateResponse = genRetrieve.retrieveResource(requestResourceId, aeId, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.OK.getOnem2mStatusCode(), containerUpdateResponse.getResponseStatusCode());
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_RET_013_STCG")
	void TP_oneM2M_CSE_DMR_RET_013_STCG() {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_RET_013_STCL")
	void TP_oneM2M_CSE_DMR_RET_013_STCL() {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_RET_013_TS")
	void TP_oneM2M_CSE_DMR_RET_013_TS() {
