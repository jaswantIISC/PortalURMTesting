...
@Tag("TP_oneM2M_CSE_DMR_RET_020")
public class TP_oneM2M_CSE_DMR_RET_020 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_RET_020_RCN_0")
	void TP_oneM2M_CSE_DMR_RET_020_RCN_0() {
		...
		// TEST EVENT STARTS
		// CONT RETRIEVE
		OneM2MResponse containerUpdateResponse = genRetrieve.retrieveResourceWithCustomRCN(0, container1StructuredResourceId, aeId, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_RET_020_RCN_2")
	void TP_oneM2M_CSE_DMR_RET_020_RCN_2() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		// TEST EVENT STARTS
		// CONT RETRIEVE
		OneM2MResponse containerUpdateResponse = genRetrieve.retrieveResourceWithCustomRCN(2, container1StructuredResourceId, aeId, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.BAD_REQUEST.getOnem2mStatusCode(), containerUpdateResponse.getResponseStatusCode());
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_RET_020_RCN_3")
	void TP_oneM2M_CSE_DMR_RET_020_RCN_3() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		// TEST EVENT STARTS
		// CONT RETRIEVE
		OneM2MResponse containerUpdateResponse = genRetrieve.retrieveResourceWithCustomRCN(3, container1StructuredResourceId, aeId, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.BAD_REQUEST.getOnem2mStatusCode(), containerUpdateResponse.getResponseStatusCode());
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_RET_020_RCN_9")
	void TP_oneM2M_CSE_DMR_RET_020_RCN_9() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		// TEST EVENT STARTS
		// CONT RETRIEVE
		OneM2MResponse containerUpdateResponse = genRetrieve.retrieveResourceWithCustomRCN(9, container1StructuredResourceId, aeId, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.BAD_REQUEST.getOnem2mStatusCode(), containerUpdateResponse.getResponseStatusCode());
