...
@Tag("TP_oneM2M_CSE_DMR_RET_021")
public class TP_oneM2M_CSE_DMR_RET_021 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_RET_021_CNT")
	void TP_oneM2M_CSE_GEN_CRE_021_CNT() {
		...
		// TEST EVENT STARTS
		// CONT RETRIEVE
		OneM2MResponse containerUpdateResponse = genRetrieve.retrieveResourceWithCustomRCN(1, container1ResourceId, aeId, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		...
		assertThat(containerUpdateResponse.getPrimitiveContent().getAny().getClass(), not(ResourceWrapper.class));
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_RET_021_GRP")
	void TP_oneM2M_CSE_DMR_RET_021_GRP() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		...
		OneM2MResponse groupRetrieveResponse = genRetrieve.retrieveResourceWithCustomRCN(1, groupStructuredResourceId, aeId, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
	...
	@Test
	@Tag("TP_oneM2M_CSE_GEN_UPD_021_ACP")
	void TP_oneM2M_CSE_DMR_RET_021_ACP() {
		...
		// TEST EVENT STARTS
		// CONTAINER UPDATE
		OneM2MResponse acpRetrieveResponse = genRetrieve.retrieveResourceWithCustomRCN(1, container1StructuredResourceId, aeId, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
	...
	void TP_oneM2M_CSE_DMR_RET_004_PCH() {
		...
		// TEST EVENT STARTS
		// CONT RETRIEVE
		OneM2MResponse pcRetrieveResponse = genRetrieve.retrieveResourceWithCustomRCN(1, container1StructuredResourceId, aeId, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_RET_021_SUB")
	void TP_oneM2M_CSE_DMR_RET_021_SUB() {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_RET_021_TS")
	void TP_oneM2M_CSE_DMR_RET_021_TS() {
