...
@Tag("TP_oneM2M_CSE_DMR_RET_022")
public class TP_oneM2M_CSE_DMR_RET_022 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_RET_022_CNT")
	void TP_oneM2M_CSE_GEN_CRE_022_CNT() {
		...
		// TEST EVENT STARTS
		// CONT RETRIEVE
		OneM2MResponse containerUpdateResponse = genRetrieve.retrieveResourceWithCustomRCN(4, container1ResourceId, aeId, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		...
		if (containerUpdateResponse.getPrimitiveContent().getAny() instanceof ResourceWrapper) {
			ResourceWrapper resWrapper = (ResourceWrapper) containerUpdateResponse.getPrimitiveContent().getAny();
			cont = (Container) resWrapper.getSgResource();
			assertEquals(M2MSimpleResources.CONTAINER.getM2MResourceTypes().intValue(), cont.getResourceType().intValue());
			assertNotNull(cont.getParentID());
			assertNotNull(resWrapper.getSgSubordinateResource());
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_RET_022_GRP")
	void TP_oneM2M_CSE_DMR_RET_022_GRP() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		...
		OneM2MResponse groupRetrieveResponse = genRetrieve.retrieveResourceWithCustomRCN(4, groupStructuredResourceId, aeId, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
...
//		assertNotNull(group.getParentID());
//		assertThat(groupRetrieveResponse.getPrimitiveContent().getAny().getClass(), not(ResourceWrapper.class));
		...
		if (groupRetrieveResponse.getPrimitiveContent().getAny() instanceof ResourceWrapper) {
			ResourceWrapper resWrapper = (ResourceWrapper) groupRetrieveResponse.getPrimitiveContent().getAny();
			group = (Group) resWrapper.getSgResource();
			assertEquals(M2MSimpleResources.GROUP.getM2MResourceTypes().intValue(), group.getResourceType().intValue());
			assertNotNull(group.getParentID());
			assertNotNull(resWrapper.getSgSubordinateResource());
	...
	@Test
	@Tag("TP_oneM2M_CSE_GEN_UPD_022_ACP")
	void TP_oneM2M_CSE_DMR_RET_022_ACP() {
		...
		// TEST EVENT STARTS
		// CONTAINER UPDATE
		OneM2MResponse acpRetrieveResponse = genRetrieve.retrieveResourceWithCustomRCN(4, container1StructuredResourceId, aeId, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
...
//		assertNotNull(acp.getParentID());
//		assertThat(acpRetrieveResponse.getPrimitiveContent().getAny().getClass(), not(ResourceWrapper.class));
		...
		if (acpRetrieveResponse.getPrimitiveContent().getAny() instanceof ResourceWrapper) {
			ResourceWrapper resWrapper = (ResourceWrapper) acpRetrieveResponse.getPrimitiveContent().getAny();
			acp = (AccessControlPolicy) resWrapper.getSgResource();
			assertEquals(M2MSimpleResources.ACCESSCONTROLPOLICY.getM2MResourceTypes().intValue(), acp.getResourceType().intValue());
			assertNotNull(acp.getParentID());
			assertNotNull(resWrapper.getSgSubordinateResource());
...
//	@Test
//	@Tag("TP_oneM2M_CSE_DMR_RET_022_PCH")
//	void TP_oneM2M_CSE_DMR_RET_022_PCH() {
...
//		// TEST EVENT STARTS
//		// CONT RETRIEVE
//		OneM2MResponse pcRetrieveResponse = genRetrieve.retrieveResourceWithCustomRCN(4, container1StructuredResourceId, aeId, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
...
////		String creationTime = pc.getCreationTime();
////		assertNotNull(creationTime);
////		assertThat(pcRetrieveResponse.getPrimitiveContent().getAny().getClass(), not(ResourceWrapper.class));
//
...
//			ResourceWrapper resWrapper = (ResourceWrapper) pcRetrieveResponse.getPrimitiveContent().getAny();
//			pc = (PollingChannel) resWrapper.getSgResource();
//			assertEquals(M2MSimpleResources.POLLINGCHANNEL.getM2MResourceTypes().intValue(), pc.getResourceType().intValue());
//			assertNotNull(pc.getParentID());
//			assertNotNull(resWrapper.getSgSubordinateResource());
//
//		}
//		// CONTAINER UPDATE ENDS
...
//	@Test
//	@Tag("TP_oneM2M_CSE_DMR_RET_022_SUB")
//	void TP_oneM2M_CSE_DMR_RET_022_SUB() {
//
//		SubscriptionCreate subCreate = new SubscriptionCreate();
//		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
//
...
////		assertNotNull(sub.getParentID());
////		assertThat(acpRetrieveResponse.getPrimitiveContent().getAny().getClass(), not(ResourceWrapper.class));
//
//		assertTrue(acpRetrieveResponse.getPrimitiveContent().getAny() instanceof ResourceWrapper);
//		if (acpRetrieveResponse.getPrimitiveContent().getAny() instanceof ResourceWrapper) {
//			ResourceWrapper resWrapper = (ResourceWrapper) acpRetrieveResponse.getPrimitiveContent().getAny();
//			acp = (Subscription) resWrapper.getSgResource();
//			assertEquals(M2MSimpleResources.SUBSCRIPTION.getM2MResourceTypes().intValue(), acp.getResourceType().intValue());
//			assertNotNull(acp.getParentID());
//			assertNotNull(resWrapper.getSgSubordinateResource());
//
//		}
...
//	}
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_RET_022_TS")
	void TP_oneM2M_CSE_DMR_RET_022_TS() {
...
//		assertNotNull(ts.getParentID());
//		assertThat(pcRetrieveResponse.getPrimitiveContent().getAny().getClass(), not(ResourceWrapper.class));

		assertTrue(pcRetrieveResponse.getPrimitiveContent().getAny() instanceof ResourceWrapper);
		if (pcRetrieveResponse.getPrimitiveContent().getAny() instanceof ResourceWrapper) {
			ResourceWrapper resWrapper = (ResourceWrapper) pcRetrieveResponse.getPrimitiveContent().getAny();
			ts = (TimeSeries) resWrapper.getSgResource();
			assertEquals(M2MSimpleResources.SUBSCRIPTION.getM2MResourceTypes().intValue(), ts.getResourceType().intValue());
			assertNotNull(ts.getParentID());
			assertNotNull(resWrapper.getSgSubordinateResource());
