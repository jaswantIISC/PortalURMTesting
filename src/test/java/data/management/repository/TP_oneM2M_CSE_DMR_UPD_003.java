...
@Tag("TP_oneM2M_CSE_DMR_UPD_003")
public class TP_oneM2M_CSE_DMR_UPD_003 {
...
//	@Disabled
//	@Test
//	@Tag("TP_oneM2M_CSE_DMR_UPD_003_CNT")
//	void TP_oneM2M_CSE_DMR_UPD_003_CNT() {
...
//		OneM2MResponse containerUpdateResponse = contUpdate.updateContainerLabelOnlyUpdate(Arrays.asList(""), container1ResourceId, aeId, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
...
//	@Disabled
//	@Test
//	@Tag("TP_oneM2M_CSE_DMR_UPD_003_ACP")
//	void TP_oneM2M_CSE_DMR_UPD_003_ACP() {
//
...
//		OneM2MResponse acpRetrieveResponse = acpUpdate.updateLabelsACP(Arrays.asList(""), container1StructuredResourceId, aeId, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
...
//	@Disabled
//	@Test
//	@Tag("TP_oneM2M_CSE_DMR_UPD_003_SUB")
//	void TP_oneM2M_CSE_DMR_UPD_003_SUB() {
//
...
//		OneM2MResponse acpRetrieveResponse = subUpdate.updateLabelsSUB(Arrays.asList(""), container1StructuredResourceId, aeId, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
//		assertEquals(M2MStatus.UPDATED.getOnem2mStatusCode(), acpRetrieveResponse.getResponseStatusCode());
...
//	@Disabled
//	@Test
//	@Tag("TP_oneM2M_CSE_DMR_UPD_003_GRP")
//	void TP_oneM2M_CSE_DMR_UPD_003_GRP() {
//		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
...
//		OneM2MResponse groupRetrieveResponse = grpUpdate.updateLabelsGRP(Arrays.asList(""), groupStructuredResourceId, aeId, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
...
//	@Disabled
//	@Test
//	@Tag("TP_oneM2M_CSE_DMR_UPD_003_PCH")
//	void TP_oneM2M_CSE_DMR_UPD_003_PCH() {
...
//		OneM2MResponse pcRetrieveResponse = pcUpdate.updateLabelsPollingChannel(Arrays.asList(""), container1StructuredResourceId, aeId, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
...
//	@Disabled
//	@Test
//	@Tag("TP_oneM2M_CSE_DMR_UPD_003_TS")
//	void TP_oneM2M_CSE_DMR_UPD_003_TS() {
...
//		OneM2MResponse pcRetrieveResponse = tsUpdate.updateLabels(Arrays.asList(""), container1StructuredResourceId, aeId, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
//		assertEquals(M2MStatus.UPDATED.getOnem2mStatusCode(), pcRetrieveResponse.getResponseStatusCode());
