...
@Tag("TP_oneM2M_CSE_DMR_UPD_005")
public class TP_oneM2M_CSE_DMR_UPD_005 {

	String aeId;
	String aeResourceID;
	String aeStructuredResourceID;
	String container1ResourceId = null;
	String container1StructuredResourceId = null;
	...
	public class NestedTestCases {
		@Test
		@Tag("TP_oneM2M_CSE_DMR_UPD_005")
		void TP_oneM2M_CSE_DMR_UPD_005() {
			...
			OneM2MResponse containerUpdateResponse = contUpdate.updateContainerLabelOnlyUpdate(Arrays.asList("Hello"), "XYZ12345", aeId, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
