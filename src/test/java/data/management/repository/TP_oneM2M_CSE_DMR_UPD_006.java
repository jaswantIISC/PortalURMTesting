...
@Tag("TP_oneM2M_CSE_DMR_UPD_006")
public class TP_oneM2M_CSE_DMR_UPD_006 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_UPD_006_CNT_LBL")
	void TP_oneM2M_CSE_DMR_UPD_006_CNT_LBL() {
		...
		OneM2MResponse containerUpdateResponse = contUpdate.updateContainerLabelOnlyUpdate(Arrays.asList("Update"), container1ResourceId, TestingParams.ADMIN_AE_ID, TestingParams.getSecurityParams(TestingParams.ADMIN_AE_ID));
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_UPD_006_ACP_LBL")
	void TP_oneM2M_CSE_DMR_UPD_006_ACP_LBL() {
		...
		OneM2MResponse acpRetrieveResponse = acpUpdate.updateLabelsACP(Arrays.asList("Update"), container1StructuredResourceId, TestingParams.ADMIN_AE_ID, TestingParams.getSecurityParams(TestingParams.ADMIN_AE_ID));
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_UPD_006_SUB_LBL")
	void TP_oneM2M_CSE_DMR_UPD_006_SUB_LBL() {
		...
		OneM2MResponse acpRetrieveResponse = subUpdate.updateLabelsSUB(Arrays.asList("Update"), container1StructuredResourceId, TestingParams.ADMIN_AE_ID, TestingParams.getSecurityParams(TestingParams.ADMIN_AE_ID));
		assertEquals(M2MStatus.ACCESS_DENIED.getOnem2mStatusCode(), acpRetrieveResponse.getResponseStatusCode());
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_UPD_006_GRP_LBL")
	void TP_oneM2M_CSE_DMR_UPD_006_GRP_LBL() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		...
		OneM2MResponse groupRetrieveResponse = grpUpdate.updateLabelsGRP(Arrays.asList("Update"), groupStructuredResourceId, TestingParams.ADMIN_AE_ID, TestingParams.getSecurityParams(TestingParams.ADMIN_AE_ID));
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_UPD_006_PCH_LBL")
	void TP_oneM2M_CSE_DMR_UPD_006_PCH_LBL() {
		...
		OneM2MResponse pcRetrieveResponse = pcUpdate.updateLabelsPollingChannel(Arrays.asList("Update"), container1StructuredResourceId, TestingParams.ADMIN_AE_ID, TestingParams.getSecurityParams(TestingParams.ADMIN_AE_ID));
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_UPD_006_TS_LBL")
	void TP_oneM2M_CSE_DMR_UPD_006_TS_LBL() {
		...
		OneM2MResponse pcRetrieveResponse = tsUpdate.updateLabels(Arrays.asList("Update"), container1StructuredResourceId, TestingParams.ADMIN_AE_ID, TestingParams.getSecurityParams(TestingParams.ADMIN_AE_ID));
		assertEquals(M2MStatus.ACCESS_DENIED.getOnem2mStatusCode(), pcRetrieveResponse.getResponseStatusCode());
		// CONTAINER UPDATE ENDS
