...
@Tag("TP_oneM2M_CSE_DMR_UPD_008")
public class TP_oneM2M_CSE_DMR_UPD_008 {
...
//	@Disabled
//	@Test
//	@Tag("TP_oneM2M_CSE_DMR_UPD_008_CNT_ET")
//	void TP_oneM2M_CSE_DMR_UPD_008_CNT_ET() {
...
//		OneM2MResponse containerUpdateResponse = contUpdate.updateContainerExpirationTime(container1ResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
...
//	}
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_UPD_008_ACP_PVS")
	void TP_oneM2M_CSE_DMR_UPD_008_ACP_PVS() {
		...
		OneM2MResponse acpRetrieveResponse = acpUpdate.updateSelfPrivilegeACP(container1StructuredResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
...
//	@Disabled
//	@Test
//	@Tag("TP_oneM2M_CSE_DMR_UPD_008_SUB_NU")
//	void TP_oneM2M_CSE_DMR_UPD_008_SUB_NU() {
//
...
//		OneM2MResponse acpRetrieveResponse = subUpdate.updateNotificationURISUB(container1StructuredResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
//		assertEquals(M2MStatus.BAD_REQUEST.getOnem2mStatusCode(), acpRetrieveResponse.getResponseStatusCode());
//
//		// CONTAINER UPDATE ENDS
//
...
//	@Disabled
//	@Test
//	@Tag("TP_oneM2M_CSE_DMR_UPD_008_GRP_MNI")
//	void TP_oneM2M_CSE_DMR_UPD_008_GRP_MNI() {
//		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
...
//		OneM2MResponse groupRetrieveResponse = grpUpdate.updateMaxNumberOfInstancesGRP(groupStructuredResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
...
//	@Disabled
//	@Test
//	@Tag("TP_oneM2M_CSE_DMR_UPD_008_PCH_ET")
//	void TP_oneM2M_CSE_DMR_UPD_008_PCH_ET() {
...
//		OneM2MResponse pcRetrieveResponse = pcUpdate.updateExpirationTimePollingChannel(container1StructuredResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
...
//	@Disabled
//	@Test
//	@Tag("TP_oneM2M_CSE_DMR_UPD_008_TS_ET")
//	void TP_oneM2M_CSE_DMR_UPD_008_TS_ET() {
...
//		OneM2MResponse pcRetrieveResponse = tsUpdate.updateExpirationTimeTS(container1StructuredResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
//		assertEquals(M2MStatus.BAD_REQUEST.getOnem2mStatusCode(), pcRetrieveResponse.getResponseStatusCode());
//		// CONTAINER UPDATE ENDS
//		// TEST EVENT ENDS
//
