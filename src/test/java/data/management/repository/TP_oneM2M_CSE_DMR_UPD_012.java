...
@Tag("TP_oneM2M_CSE_DMR_UPD_012")
public class TP_oneM2M_CSE_DMR_UPD_012 {
	...
	public class innerTestCase {
		...
		@Test
		@Tag("TP_oneM2M_CSE_DMR_UPD_012")
		void TP_oneM2M_CSE_DMR_UPD_012() {
			...
			OneM2MResponse subUpdateResponse = ciUpdate.updateWithEmptyPayload(container1ResourceId + "/la", TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
