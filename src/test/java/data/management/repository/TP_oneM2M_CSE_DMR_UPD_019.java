...
@Tag("TP_oneM2M_CSE_DMR_UPD_019")
public class TP_oneM2M_CSE_DMR_UPD_019 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_UPD_019_RCN_2")
	void TP_oneM2M_CSE_DMR_UPD_019_RCN_2() {
		...
		OneM2MResponse containerUpdateResponse = contUpdate.updateLabelWithRCNValue(BigInteger.valueOf(2), Arrays.asList("NewLabel"), container1ResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_UPD_019_RCN_3")
	void TP_oneM2M_CSE_DMR_UPD_019_RCN_3() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		// CONT RETRIEVE
		ContainerUpdateTestCases contUpdate = new ContainerUpdateTestCases();
		OneM2MResponse containerUpdateResponse = contUpdate.updateLabelWithRCNValue(BigInteger.valueOf(3), Arrays.asList("NewLabel"), container1ResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.BAD_REQUEST.getOnem2mStatusCode(), containerUpdateResponse.getResponseStatusCode());
		// CONTAINER UPDATE ENDS
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_UPD_019_RCN_4")
	void TP_oneM2M_CSE_DMR_UPD_019_RCN_4() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		// CONT RETRIEVE
		ContainerUpdateTestCases contUpdate = new ContainerUpdateTestCases();
		OneM2MResponse containerUpdateResponse = contUpdate.updateLabelWithRCNValue(BigInteger.valueOf(4), Arrays.asList("NewLabel"), container1ResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.BAD_REQUEST.getOnem2mStatusCode(), containerUpdateResponse.getResponseStatusCode());
		// CONTAINER UPDATE ENDS
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_UPD_019_RCN_5")
	void TP_oneM2M_CSE_DMR_UPD_019_RCN_5() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		// CONT RETRIEVE
		ContainerUpdateTestCases contUpdate = new ContainerUpdateTestCases();
		OneM2MResponse containerUpdateResponse = contUpdate.updateLabelWithRCNValue(BigInteger.valueOf(5), Arrays.asList("NewLabel"), container1ResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.BAD_REQUEST.getOnem2mStatusCode(), containerUpdateResponse.getResponseStatusCode());
		// CONTAINER UPDATE ENDS
		// TEST EVENT ENDS
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_UPD_019_RCN_6")
	void TP_oneM2M_CSE_DMR_UPD_019_RCN_6() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		// CONT RETRIEVE
		ContainerUpdateTestCases contUpdate = new ContainerUpdateTestCases();
		OneM2MResponse containerUpdateResponse = contUpdate.updateLabelWithRCNValue(BigInteger.valueOf(6), Arrays.asList("NewLabel"), container1ResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.BAD_REQUEST.getOnem2mStatusCode(), containerUpdateResponse.getResponseStatusCode());
		// CONTAINER UPDATE ENDS
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_UPD_019_RCN_7")
	void TP_oneM2M_CSE_DMR_UPD_019_RCN_7() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		// CONT RETRIEVE
		ContainerUpdateTestCases contUpdate = new ContainerUpdateTestCases();
		OneM2MResponse containerUpdateResponse = contUpdate.updateLabelWithRCNValue(BigInteger.valueOf(7), Arrays.asList("NewLabel"), container1ResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.BAD_REQUEST.getOnem2mStatusCode(), containerUpdateResponse.getResponseStatusCode());
		// CONTAINER UPDATE ENDS
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_UPD_019_RCN_8")
	void TP_oneM2M_CSE_DMR_UPD_019_RCN_8() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		// CONT RETRIEVE
		ContainerUpdateTestCases contUpdate = new ContainerUpdateTestCases();
		OneM2MResponse containerUpdateResponse = contUpdate.updateLabelWithRCNValue(BigInteger.valueOf(8), Arrays.asList("NewLabel"), container1ResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.BAD_REQUEST.getOnem2mStatusCode(), containerUpdateResponse.getResponseStatusCode());
		// CONTAINER UPDATE ENDS
