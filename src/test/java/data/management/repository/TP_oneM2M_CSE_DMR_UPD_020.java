...
@Tag("TP_oneM2M_CSE_DMR_UPD_020")
public class TP_oneM2M_CSE_DMR_UPD_020 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_UPD_020_CNT")
	void TP_oneM2M_CSE_DMR_UPD_020_CNT() {
		...
		OneM2MResponse containerUpdateResponse = contUpdate.updateLabelWithRCNValue(BigInteger.valueOf(0), Arrays.asList("NewLabel"), container1ResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.UPDATED.getOnem2mStatusCode(), containerUpdateResponse.getResponseStatusCode());
		assertEquals(null, containerUpdateResponse.getPrimitiveContent().getAny());
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_UPD_020_GRP")
	void TP_oneM2M_CSE_DMR_UPD_020_GRP() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		...
		OneM2MResponse groupRetrieveResponse = grpUpdate.updateLabelsWithRCN(BigInteger.valueOf(0), Arrays.asList("NewLabel"), groupStructuredResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.UPDATED.getOnem2mStatusCode(), groupRetrieveResponse.getResponseStatusCode());
		assertEquals(null, groupRetrieveResponse.getPrimitiveContent().getAny());
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_UPD_020_ACP")
	void TP_oneM2M_CSE_DMR_UPD_020_ACP() {
		...
		OneM2MResponse acpRetrieveResponse = acpUpdate.updateLabelsWithRCN(BigInteger.valueOf(0), Arrays.asList("NewLabel"), container1StructuredResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.UPDATED.getOnem2mStatusCode(), acpRetrieveResponse.getResponseStatusCode());
		assertEquals(null, acpRetrieveResponse.getPrimitiveContent().getAny());
		// CONTAINER UPDATE ENDS
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_UPD_020_PCH")
	void TP_oneM2M_CSE_DMR_UPD_020_PCH() {
...
//		String subStructuredResourceId = container1StructuredResourceId + "/" + sub.getResourceName();
		...
		OneM2MResponse pcRetrieveResponse = pcUpdate.updateLabelsWithRCN(BigInteger.valueOf(0), Arrays.asList("NewLabel"), container1StructuredResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.UPDATED.getOnem2mStatusCode(), pcRetrieveResponse.getResponseStatusCode());
		assertEquals(null, pcRetrieveResponse.getPrimitiveContent().getAny());
...
//		System.out.println(" SUBSCRIPTION  STRUCTURED RESOURCE ID : " + subStructuredResourceId);
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_UPD_020_SUB")
	void TP_oneM2M_CSE_DMR_UPD_020_SUB() {
		...
		OneM2MResponse acpRetrieveResponse = subUpdate.updateLabelWithRCN(BigInteger.valueOf(0), Arrays.asList("NewLabel"), container1StructuredResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.UPDATED.getOnem2mStatusCode(), acpRetrieveResponse.getResponseStatusCode());
		assertEquals(null, acpRetrieveResponse.getPrimitiveContent().getAny());
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_UPD_020_TS")
	void TP_oneM2M_CSE_DMR_UPD_020_TS() {
		...
		OneM2MResponse pcRetrieveResponse = tsUpdate.updateLabelWithRCN(BigInteger.valueOf(0), Arrays.asList("NewLabel"), container1StructuredResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.UPDATED.getOnem2mStatusCode(), pcRetrieveResponse.getResponseStatusCode());
		assertEquals(null, pcRetrieveResponse.getPrimitiveContent().getAny());
