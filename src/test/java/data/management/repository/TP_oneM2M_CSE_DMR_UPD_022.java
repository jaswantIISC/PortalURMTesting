...
@Tag("TP_oneM2M_CSE_DMR_UPD_022")
public class TP_oneM2M_CSE_DMR_UPD_022 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_UPD_022_CNT")
	void TP_oneM2M_CSE_DMR_UPD_022_CNT() {
		...
		OneM2MResponse containerUpdateResponse = contUpdate.updateLabelWithRCNValue(BigInteger.valueOf(9), Arrays.asList("NewLabel"), container1ResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		...
		if (!(containerUpdateResponse.getPrimitiveContent().getAny() instanceof ResourceWrapper)) {
			...
			assertEquals(null, cont.getLabels());
			assertEquals(null, cont.getChildResource());
			assertTrue(cont.getStateTag() != null);
			assertTrue(cont.getLastModifiedTime() != null);
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_UPD_022_GRP")
	void TP_oneM2M_CSE_DMR_UPD_022_GRP() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		...
		OneM2MResponse groupRetrieveResponse = grpUpdate.updateLabelsWithRCN(BigInteger.valueOf(9), Arrays.asList("NewLabel"), groupStructuredResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		...
		if(!(groupRetrieveResponse.getPrimitiveContent().getAny() instanceof ResourceWrapper)) {
			...
			assertEquals(null, group.getLabels());
			assertEquals(null, group.getChildResource());
			assertTrue(group.getLastModifiedTime() != null);
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_UPD_022_ACP")
	void TP_oneM2M_CSE_DMR_UPD_022_ACP() {
		...
		OneM2MResponse acpRetrieveResponse = acpUpdate.updateLabelsWithRCN(BigInteger.valueOf(9), Arrays.asList("NewLabel"), container1StructuredResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		...
		if (!(acpRetrieveResponse.getPrimitiveContent().getAny() instanceof ResourceWrapper)) {
			...
			assertEquals(null, acp.getLabels());
			assertEquals(null, acp.getChildResource());
			assertTrue(acp.getLastModifiedTime() != null);
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_UPD_022_PCH")
	void TP_oneM2M_CSE_DMR_UPD_022_PCH() {
...
//		String subStructuredResourceId = container1StructuredResourceId + "/" + sub.getResourceName();
		...
		OneM2MResponse pcRetrieveResponse = pcUpdate.updateLabelsWithRCN(BigInteger.valueOf(9), Arrays.asList("NewLabel"), container1StructuredResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		...
		if (!(pcRetrieveResponse.getPrimitiveContent().getAny() instanceof ResourceWrapper)) {
			...
			assertEquals(null, pc.getLabels());
			assertEquals(null, pc.getChildResource());
			assertTrue(pc.getLastModifiedTime() != null);
...
//		System.out.println(" SUBSCRIPTION  STRUCTURED RESOURCE ID : " + subStructuredResourceId);
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_UPD_022_SUB")
	void TP_oneM2M_CSE_DMR_UPD_022_SUB() {
		...
		OneM2MResponse acpRetrieveResponse = subUpdate.updateLabelWithRCN(BigInteger.valueOf(9), Arrays.asList("NewLabel"), container1StructuredResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.UPDATED.getOnem2mStatusCode(), acpRetrieveResponse.getResponseStatusCode());
		if (!(acpRetrieveResponse.getPrimitiveContent().getAny() instanceof ResourceWrapper)) {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DMR_UPD_022_TS")
	void TP_oneM2M_CSE_DMR_UPD_022_TS() {
		...
		OneM2MResponse pcRetrieveResponse = tsUpdate.updateLabelWithRCN(BigInteger.valueOf(9), Arrays.asList("NewLabel"), container1StructuredResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.UPDATED.getOnem2mStatusCode(), pcRetrieveResponse.getResponseStatusCode());
		if (!(pcRetrieveResponse.getPrimitiveContent().getAny() instanceof ResourceWrapper)) {
			ts = (TimeSeries) pcRetrieveResponse.getPrimitiveContent().getAny();
			assertEquals(null, ts.getLabels());
			assertEquals(null, ts.getChildResource());
			assertTrue(ts.getLastModifiedTime() != null);
			//assertTrue(ts.getStateTag() != null);
			assertTrue(!(pcRetrieveResponse.getPrimitiveContent().getAny() instanceof ResourceWrapper));
		}
