...
@Tag("TP_oneM2M_CSE_DIS_003")
public class TP_oneM2M_CSE_DIS_003 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DIS_003_DIS")
	void TP_oneM2M_CSE_DIS_003_DIS() {
		...
		filCri.setResourceType(Arrays.asList(M2MSimpleResources.CONTAINER.getM2MResourceTypes()));
