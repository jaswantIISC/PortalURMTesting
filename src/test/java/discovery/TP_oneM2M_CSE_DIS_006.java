...
@Tag("TP_oneM2M_CSE_DIS_006")
public class TP_oneM2M_CSE_DIS_006 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DIS_006_DIS")
	void TP_oneM2M_CSE_DIS_006_DIS() {
		...
		OneM2MResponse disRes = genRet.retrieveForDiscovery(filCri, "XYZ12345", TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.NOT_FOUND.getOnem2mStatusCode(), disRes.getResponseStatusCode());
