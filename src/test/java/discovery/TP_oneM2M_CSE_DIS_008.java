...
@Tag("TP_oneM2M_CSE_DIS_008")
public class TP_oneM2M_CSE_DIS_008 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DIS_008_CRB_CRA")
	void TP_oneM2M_CSE_DIS_008_CRB_CRA() {
		...
		OneM2MResponse conRes = conCreate.containerWithExternalACPIDs(aeResourceID, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID), Arrays.asList(acp.getResourceID()));
		...
		OneM2MResponse ciRes = ciCreate.createWithAnyAttribute(container1ResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.CREATED.getOnem2mStatusCode(), ciRes.getResponseStatusCode());
		ContentInstance ci = (ContentInstance) ciRes.getPrimitiveContent().getAny();
		String ciRID = ci.getResourceID();
		String ciStrutId = container1StructuredResourceId + "/" + ci.getResourceID();
		...
		String createdAfter = sdf.format(cal.getTime());
		cal = Calendar.getInstance();
		cal.add(Calendar.DAY_OF_MONTH, -2);
		String createdBefore = sdf.format(cal.getTime());
		filCri.setCreatedAfter(createdAfter);
		filCri.setCreatedBefore(createdBefore);

		OneM2MResponse disRes = genRet.retrieveForDiscovery(filCri, container1StructuredResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.CONTENTS_UNACCEPTABLE.getOnem2mStatusCode(), disRes.getResponseStatusCode());
	...
	@Test
	@Tag("TP_oneM2M_CSE_DIS_008_MS_US")
	void TP_oneM2M_CSE_DIS_008_MS_US() {
		...
		Calendar cal = Calendar.getInstance();
		cal.add(Calendar.DAY_OF_MONTH, 2);
		String unModifiedSince = sdf.format(cal.getTime());
		cal = Calendar.getInstance();
		cal.add(Calendar.DAY_OF_MONTH, -2);
		String modifiedSince = sdf.format(cal.getTime());
		filCri.setUnmodifiedSince(modifiedSince);
		filCri.setModifiedSince(unModifiedSince);
	...
	@Test
	@Tag("TP_oneM2M_CSE_DIS_008_STS_STB")
	void TP_oneM2M_CSE_DIS_008_STS_STB() {
		...
		filCri.setStateTagBigger(BigInteger.valueOf(20));
		filCri.setStateTagSmaller(BigInteger.valueOf(10));
	...
	@Test
	@Tag("TP_oneM2M_CSE_DIS_008_EXB_EXA")
	void TP_oneM2M_CSE_DIS_008_EXB_EXA() {
		...
		Calendar cal = Calendar.getInstance();
		cal.add(Calendar.DAY_OF_MONTH, 2);
		String expireAfter = sdf.format(cal.getTime());
		cal = Calendar.getInstance();
		cal.add(Calendar.DAY_OF_MONTH, -2);
		String expireBefore = sdf.format(cal.getTime());
		filCri.setExpireAfter(expireAfter);
		filCri.setExpireBefore(expireBefore);
