...
@Tag("TP_oneM2M_CSE_DIS_010")
public class TP_oneM2M_CSE_DIS_010 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_DIS_010_DIS")
	void TP_oneM2M_CSE_DIS_010_DIS() {
		...
		OneM2MResponse disRes = genRet.retrieveForDiscoveryAndDRI(BigInteger.valueOf(1), filCri, container1StructuredResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
