...
@Tag("TP_oneM2M_CSE_GEN_CRE_002")
public class TP_oneM2M_CSE_GEN_CRE_002 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_GEN_CRE_002_CSR")
	void TP_oneM2M_CSE_GEN_CRE_002_CSR() {
		...
		container2StructuredResourceId = container1StructuredResourceId;
		// INITIAL STATE ENDS

		// TEST EVENT STARTS
		// CONTAINER CREATE 2
		OneM2MResponse container2Response = contCreate.createWithAnyAttribute(container1StructuredResourceId, aeId, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		...
		container2ResourceId = cont2.getResourceID();
		container2StructuredResourceId = container2StructuredResourceId + "/" + cont2.getResourceName();
		// CONTAINER CREATE 2 ENDS

//		if (TestingParams.DELETE_ALL_RESOURCES) {
//			AEReRegistration aeDelete = new AEReRegistration();
//			OneM2MResponse aeDeleteResponse = aeDelete.aeDeregister(aeStructuredResourceID, aeId, TestingParams.ADN_AE_PSK_ID, TestingParams.ADN_AE_PSK);
...
//		}
	...
	@Test
	@Tag("TP_oneM2M_CSE_GEN_CRE_001_SPR")
	void TP_oneM2M_CSE_GEN_CRE_001_SPR() {

		aeStructuredResourceID = TestingParams.CSE_ID + "/" + TestingParams.CSE_BASE_RESOURCE_NAME;
		...
		// TEST EVENT STARTS
		// CONTAINER CREATE 2
		OneM2MResponse container2Response = contCreate.createWithAnyAttribute(TestingParams.CSE_ID + "/" + container1ResourceId, aeId, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.CREATED.getOnem2mStatusCode(), container2Response.getResponseStatusCode());
		Container cont2 = (Container) container2Response.getPrimitiveContent().getAny();
		container2ResourceId = cont2.getResourceID();
		container2StructuredResourceId = container2StructuredResourceId + "/" + cont2.getResourceName();
...
//		if (TestingParams.DELETE_ALL_RESOURCES) {
//			AEReRegistration aeDelete = new AEReRegistration();
//			OneM2MResponse aeDeleteResponse = aeDelete.aeDeregister(TestingParams.CSE_ID + "/" + aeResourceID, aeId, TestingParams.ADN_AE_PSK_ID, TestingParams.ADN_AE_PSK);
//			assertEquals(M2MStatus.DELETED.getOnem2mStatusCode(), aeDeleteResponse.getResponseStatusCode());
//		}
		// TEST EVENT ENDS
