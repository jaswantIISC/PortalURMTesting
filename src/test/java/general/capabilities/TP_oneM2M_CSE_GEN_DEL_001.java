...
public class TP_oneM2M_CSE_GEN_DEL_001 {
	...
	GeneralDeleteTestCases delResource = new GeneralDeleteTestCases();
	...
	void TP_oneM2M_CSE_GEN_RET_001_CSR() {
		...
		// TEST EVENT STARTS
		// CONTAINER UPDATE
		OneM2MResponse containerUpdateResponse = delResource.deleteResource(container1ResourceId, aeId, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.DELETED.getOnem2mStatusCode(), containerUpdateResponse.getResponseStatusCode());
	...
	void TP_oneM2M_CSE_GEN_RET_001_SPR() {
		...
		// TEST EVENT STARTS
		// CONTAINER UPDATE
		OneM2MResponse containerUpdateResponse = delResource.deleteResource(TestingParams.CSE_ID + "/" + container1ResourceId, aeId, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.DELETED.getOnem2mStatusCode(), containerUpdateResponse.getResponseStatusCode());
		// CONTAINER UPDATE ENDS
		// TEST EVENT ENDS
