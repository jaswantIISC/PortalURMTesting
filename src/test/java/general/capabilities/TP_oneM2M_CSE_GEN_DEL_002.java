...
@Tag("TP_oneM2M_CSE_GEN_RET_002")
public class TP_oneM2M_CSE_GEN_DEL_002 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_GEN_RET_002_CSR")
	void TP_oneM2M_CSE_GEN_RET_002_CSR() {
		...
		// TEST EVENT STARTS
		// CONTAINER UPDATE
		OneM2MResponse containerUpdateResponse = retResource.retrieveResource(container1StructuredResourceId, aeId, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
	...
	@Test
	@Tag("TP_oneM2M_CSE_GEN_RET_002_SPR")
	void TP_oneM2M_CSE_GEN_RET_002_SPR() {
		...
		// TEST EVENT STARTS
		// CONTAINER UPDATE
		OneM2MResponse containerUpdateResponse = retResource.retrieveResource(TestingParams.CSE_ID + "/" + container1StructuredResourceId, aeId, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.OK.getOnem2mStatusCode(), containerUpdateResponse.getResponseStatusCode());
