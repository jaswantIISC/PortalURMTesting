...
@Tag("TP_oneM2M_CSE_GMG_001")
public class TP_oneM2M_CSE_GMG_001 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_GMG_001_CRE")
	void TP_oneM2M_CSE_GMG_001_CRE() {
	...
	@Test
	@Tag("TP_oneM2M_CSE_GMG_001_RET")
	void TP_oneM2M_CSE_GMG_001_RET() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
	...
	@Test
	@Tag("TP_oneM2M_CSE_GMG_001_UPD")
	void TP_oneM2M_CSE_GMG_001_UPD() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
	...
	@Test
	@Tag("TP_oneM2M_CSE_GMG_001_DEL")
	void TP_oneM2M_CSE_GMG_001_DEL() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
