...
@Tag("TP_oneM2M_CSE_GMG_004")
public class TP_oneM2M_CSE_GMG_004 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_GMG_004_CRE")
	void TP_oneM2M_CSE_GMG_004_CRE() {
	...
	@Test
	@Tag("TP_oneM2M_CSE_GMG_004_RET")
	void TP_oneM2M_CSE_GMG_004_RET() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
	...
	@Test
	@Tag("TP_oneM2M_CSE_GMG_004_UPD")
	void TP_oneM2M_CSE_GMG_004_UPD() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
	...
	@Test
	@Tag("TP_oneM2M_CSE_GMG_004_DEL")
	void TP_oneM2M_CSE_GMG_004_DEL() {
		ContainerCreateTestCases contCreate = new ContainerCreateTestCases();
		aeStructuredResourceID = TestingParams.CSE_BASE_RESOURCE_NAME;
