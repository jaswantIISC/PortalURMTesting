...
public class TP_oneM2M_CSE_GMG_CRE_001 {
	...
	void TP_oneM2M_CSE_GMG_CRE_001_CONT() {
		...
		Group grp = new Group();
		grp.setMemberIDs(Arrays.asList(container1StructuredResourceId, container2StructuredResourceId));
		grp.setMaxNrOfMembers(BigInteger.valueOf(1));
		...
		assertEquals(M2MStatus.MAX_NUMBER_OF_MEMBER_EXCEEDED.getOnem2mStatusCode(), grpRes.getResponseStatusCode());
		// INITIAL STATE ENDS
