...
@Tag("TP_oneM2M_CSE_GMG_CRE_001")
public class TP_oneM2M_CSE_GMG_CRE_002 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_GMG_CRE_001_CONT")
	void TP_oneM2M_CSE_GMG_CRE_001_CONT() {
		...
		assertEquals(BigInteger.valueOf(5105), grpRes.getResponseStatusCode()); // 5105 status code not available in M2MStatus ENUM
		// INITIAL STATE ENDS
