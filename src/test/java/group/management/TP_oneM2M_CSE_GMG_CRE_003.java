...
@Tag("TP_oneM2M_CSE_GMG_CRE_003")
public class TP_oneM2M_CSE_GMG_CRE_003 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_GMG_CRE_003_CONT")
	void TP_oneM2M_CSE_GMG_CRE_003_CONT() {
		...
		String container2ResourceId = cont.getResourceID();
		String container2StructuredResourceId = aeStructuredResourceID + "/" + cont.getResourceName();

		GroupCreate grpCreate = new GroupCreate();
		Group grp = new Group();
		grp.setMemberIDs(Arrays.asList(container1ResourceId, container2ResourceId, container1ResourceId));
		...
		assertTrue(group.getCurrentNrOfMembers().intValue() == 2);
		// INITIAL STATE ENDS
