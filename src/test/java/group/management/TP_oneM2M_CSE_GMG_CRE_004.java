...
@Tag("TP_oneM2M_CSE_GMG_CRE_004")
public class TP_oneM2M_CSE_GMG_CRE_004 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_GMG_CRE_004_CONT")
	void TP_oneM2M_CSE_GMG_CRE_004_CONT() {
		...
		Group grp = new Group();
		grp.setMemberIDs(Arrays.asList(container1ResourceId, container2ResourceId));
