...
@Tag("TP_oneM2M_CSE_GMG_CRE_005")
public class TP_oneM2M_CSE_GMG_CRE_005 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_GMG_CRE_005_CONT")
	void TP_oneM2M_CSE_GMG_CRE_005_CONT() {
		...
		grp.setMemberType(M2MSimpleResources.CONTENTINSTANCE.getM2MResourceTypes());
		grp.setConsistencyStrategy(ConsistencyStrategy.SET_MIXED.getConsistencyStrategy());
		...
		assertTrue(group.getMemberType().intValue() == BigInteger.valueOf(0).intValue());// MIXED VALUE HAS NO ENUM IN PROCEDURE
