...
@Tag("TP_oneM2M_CSE_GMG_CRE_007")
public class TP_oneM2M_CSE_GMG_CRE_007 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_GMG_CRE_007_CONT")
	void TP_oneM2M_CSE_GMG_CRE_007_CONT() {
		...
		grp.setConsistencyStrategy(ConsistencyStrategy.ABANDON_GROUP.getConsistencyStrategy());
		...
		assertEquals(M2MStatus.GROUP_MEMBER_TYPE_INCONSISTENT.getOnem2mStatusCode(), grpRes.getResponseStatusCode());
