...
@Tag("TP_oneM2M_CSE_GMG_RET_001")
public class TP_oneM2M_CSE_GMG_RET_001 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_GMG_RET_001_CONT")
	void TP_oneM2M_CSE_GMG_RET_001_CONT() {
		...
		OneM2MResponse ci1Response = ciCreate.createWithAnyAttribute(container1ResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.CREATED.getOnem2mStatusCode(), ci1Response.getResponseStatusCode());
		ContentInstance ci1 = (ContentInstance) ci1Response.getPrimitiveContent().getAny();
		...
		OneM2MResponse ci2Response = ciCreate.createWithAnyAttribute(cont2RID, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.CREATED.getOnem2mStatusCode(), ci2Response.getResponseStatusCode());
		ContentInstance ci2 = (ContentInstance) ci2Response.getPrimitiveContent().getAny();
		...
		OneM2MResponse fanRes = genRet.retrieveResource(group.getResourceID() + "/fopt/la", TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		...
		listCIs.add(ci1.getResourceID());
		listCIs.add(ci2.getResourceID());
		for (ResponsePrimitive indiRes : listRes) {
			...
			assertTrue(listCIs.contains(ci.getResourceID()));
		}
