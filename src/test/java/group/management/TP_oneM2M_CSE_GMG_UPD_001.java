...
@Tag("TP_oneM2M_CSE_GMG_UPD_001")
public class TP_oneM2M_CSE_GMG_UPD_001 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_GMG_UPD_001_CONT")
	void TP_oneM2M_CSE_GMG_UPD_001_CONT() {
		...
		container1Response = contCreate.createWithAnyAttribute(TestingParams.ADMIN_AE_ID, TestingParams.ADMIN_AE_ID, TestingParams.getSecurityParams(TestingParams.ADMIN_AE_ID));
		assertEquals(M2MStatus.CREATED.getOnem2mStatusCode(), container1Response.getResponseStatusCode());
		// CONTAINER CREATE 1 ENDS
		assertTrue(container1Response.getPrimitiveContent().getAny() instanceof Container);
		Container cont2 = (Container) container1Response.getPrimitiveContent().getAny();
		String cont2ResourceId = cont2.getResourceID();
		...
		OneM2MResponse grpUpdateRes = grpUpdate.updateMembersIds(Arrays.asList(cont2ResourceId), group.getResourceID(), TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(BigInteger.valueOf(5105), grpUpdateRes.getResponseStatusCode());
