...
@Tag("TP_oneM2M_CSE_GMG_UPD_002")
public class TP_oneM2M_CSE_GMG_UPD_002 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_GMG_UPD_002_CONT")
	void TP_oneM2M_CSE_GMG_UPD_002_CONT() {
		...
		assertTrue(group2.getCurrentNrOfMembers().intValue() == 1 && group2.getMemberIDs().contains(cont2ResourceId));
