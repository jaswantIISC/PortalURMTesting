...
@Tag("TP_oneM2M_CSE_GMG_UPD_004")
public class TP_oneM2M_CSE_GMG_UPD_004 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_GMG_UPD_004_CONT")
	void TP_oneM2M_CSE_GMG_UPD_004_CONT() {
		...
		assertTrue(BigInteger.valueOf(0).intValue() == group2.getMemberType().intValue());
