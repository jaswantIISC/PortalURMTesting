...
@Tag("TP_oneM2M_CSE_GMG_UPD_006")
public class TP_oneM2M_CSE_GMG_UPD_006 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_GMG_UPD_006_CONT")
	void TP_oneM2M_CSE_GMG_UPD_006_CONT() {
		...
		assertEquals(M2MStatus.GROUP_MEMBER_TYPE_INCONSISTENT.getOnem2mStatusCode(), grpUpdateRes.getResponseStatusCode());
