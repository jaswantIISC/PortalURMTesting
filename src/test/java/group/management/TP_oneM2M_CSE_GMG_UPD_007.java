...
@Tag("TP_oneM2M_CSE_GMG_UPD_007")
public class TP_oneM2M_CSE_GMG_UPD_007 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_GMG_UPD_007_CONT")
	void TP_oneM2M_CSE_GMG_UPD_007_CONT() {
		...
		// CONTAINER CREATE 1 ENDS
		assertTrue(container1Response.getPrimitiveContent().getAny() instanceof Container);
		Container cont3 = (Container) container1Response.getPrimitiveContent().getAny();
		String cont3RID = cont3.getResourceID();
		...
		OneM2MResponse grpUpdateRes = grpUpdate.updateMembersIds(Arrays.asList(cont2RID, cont3RID, container1ResourceId), group.getResourceID(), TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.MAX_NUMBER_OF_MEMBER_EXCEEDED.getOnem2mStatusCode(), grpUpdateRes.getResponseStatusCode());
