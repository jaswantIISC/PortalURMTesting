...
@Tag("TP_oneM2M_CSE_GMG_UPD_008")
public class TP_oneM2M_CSE_GMG_UPD_008 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_GMG_UPD_008_CONT")
	void TP_oneM2M_CSE_GMG_UPD_008_CONT() {
		...
		OneM2MResponse grpUpdateRes = grpUpdate.updateMaxNumberOfMembers(BigInteger.valueOf(1), group.getResourceID(), TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
