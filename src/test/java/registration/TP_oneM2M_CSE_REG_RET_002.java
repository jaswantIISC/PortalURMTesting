...
@Tag("TP_oneM2M_CSE_REG_RET_002")
public class TP_oneM2M_CSE_REG_RET_002 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_REG_RET_002_CST")
	void TP_oneM2M_CSE_REG_RET_002_CST() {
		...
		BigInteger cseType = ((CSEBase) cseRetrieveResponse.getPrimitiveContent().getAny()).getCseType();
		if (cseType != null) {
			System.out.println(" >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> cseType : " + cseType.intValue());
		}

		assertNotNull(cseType);
	...
	@Test
	@Tag("TP_oneM2M_CSE_REG_RET_002_NL")
	void TP_oneM2M_CSE_REG_RET_002_NL() {
		...
		// CONTAINER UPDATE
		OneM2MResponse cseRetrieveResponse = retResource.retrieveResource(TestingParams.CSE_BASE_RESOURCE_NAME, aeId, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		String nodeLink = ((CSEBase) cseRetrieveResponse.getPrimitiveContent().getAny()).getNodeLink();
		if (nodeLink != null) {
