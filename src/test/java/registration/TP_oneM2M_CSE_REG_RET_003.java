...
@Tag("TP_oneM2M_CSE_REG_RET_003")
public class TP_oneM2M_CSE_REG_RET_003 {
	...
	public class NestedTestCases {
		@Test
		@Tag("TP_oneM2M_CSE_REG_RET_003")
		void TP_oneM2M_CSE_REG_RET_003() {
			...
			assertThat(aeRetrieveResponse.getPrimitiveContent().getAny(), instanceOf(AE.class)); // assert payload is of type CSEBase only
