...
import cdot.onem2m.common.enums.M2MCseTypes;
...
@Tag("TP_oneM2M_CSE_REG_RET_005")
public class TP_oneM2M_CSE_REG_RET_005 {
	...
	public class NestedTestCases {
		@Test
		@Tag("TP_oneM2M_CSE_REG_RET_005")
		void TP_oneM2M_CSE_REG_RET_005() {
			...
			assertEquals(((CSEBase) cseRetrieveResponse.getPrimitiveContent().getAny()).getCseType().intValue(), M2MCseTypes.IN_CSE.getCseTypeId()); // assert payload is of type CSEBase only
