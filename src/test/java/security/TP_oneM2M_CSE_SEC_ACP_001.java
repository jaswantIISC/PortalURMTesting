...
@Tag("TP_oneM2M_CSE_SEC_ACP_001")
public class TP_oneM2M_CSE_SEC_ACP_001 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_SEC_ACP_001_CRE")
	void TP_oneM2M_CSE_SEC_ACP_001_CRE() {
		...
		acr.setAccessControlOperations(BigInteger.valueOf(AccessControlOperations.UP_DE_NO_DI.getValue()));
		...
		OneM2MResponse contCreateRes = contCreate.containerWithExternalACPIDs(TestingParams.GENERAL_ADN_AE_ID, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID), Arrays.asList(acp.getResourceID()));
		...
		OneM2MResponse ciResp = ciCreate.createWithAnyAttribute(cont.getResourceID(), TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
	...
	@Test
	@Tag("TP_oneM2M_CSE_SEC_ACP_001_RET")
	void TP_oneM2M_CSE_SEC_ACP_001_RET() {
	...
	@Test
	@Tag("TP_oneM2M_CSE_SEC_ACP_001_UPD")
	void TP_oneM2M_CSE_SEC_ACP_001_UPD() {
		...
		AccessControlRule acr = new AccessControlRule();
		acr.setAccessControlOriginators(Arrays.asList(TestingParams.GENERAL_ADN_AE_ID));
		acr.setAccessControlOperations(BigInteger.valueOf(AccessControlOperations.CR_DE_NO_DI.getValue()));
		setOfACRs.setAccessControlRule(Arrays.asList(acr));
		OneM2MResponse acpResponse = acpCreate.createWithCustomPrivilegeSelfPrivilege(setOfACRs, setOfACRs, TestingParams.GENERAL_ADN_AE_ID, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.CREATED.getOnem2mStatusCode(), acpResponse.getResponseStatusCode());
		AccessControlPolicy acp = (AccessControlPolicy) acpResponse.getPrimitiveContent().getAny();
		...
		OneM2MResponse ciResp = contUpd.updateContainerLabel(Arrays.asList("NewLabel"), cont.getResourceID(), TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.ACCESS_DENIED.getOnem2mStatusCode(), ciResp.getResponseStatusCode());
	...
	@Test
	@Tag("TP_oneM2M_CSE_SEC_ACP_001_DEL")
	void TP_oneM2M_CSE_SEC_ACP_001_DEL() {
		...
		AccessControlRule acr = new AccessControlRule();
		acr.setAccessControlOriginators(Arrays.asList(TestingParams.GENERAL_ADN_AE_ID));
		acr.setAccessControlOperations(BigInteger.valueOf(AccessControlOperations.CR_RE_DI_UP.getValue()));
		setOfACRs.setAccessControlRule(Arrays.asList(acr));
		OneM2MResponse acpResponse = acpCreate.createWithCustomPrivilegeSelfPrivilege(setOfACRs, setOfACRs, TestingParams.GENERAL_ADN_AE_ID, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.CREATED.getOnem2mStatusCode(), acpResponse.getResponseStatusCode());
		AccessControlPolicy acp = (AccessControlPolicy) acpResponse.getPrimitiveContent().getAny();
