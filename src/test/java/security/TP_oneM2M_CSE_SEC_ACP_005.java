...
@Tag("TP_oneM2M_CSE_SEC_ACP_005")
public class TP_oneM2M_CSE_SEC_ACP_005 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_SEC_ACP_005_CRE")
	void TP_oneM2M_CSE_SEC_ACP_005_CRE() {
		...
		} else if (systemMinute == 56) {
			accessControlWindow = "* 56-01 * * * * *";
		} else if (systemMinute == 57) {
			accessControlWindow = "* 57-02 * * * * *";
		} else if (systemMinute == 58) {
			accessControlWindow = "* 58-03 * * * * *";
		} else if (systemMinute == 59) {
			accessControlWindow = "* 59-04 * * * * *";
		} else {
			accessControlWindow = "* " + systemMinute + "-" + (systemMinute + 5) + " * * * * *";
		}
	...
	@Test
	@Tag("TP_oneM2M_CSE_SEC_ACP_005_RET")
	void TP_oneM2M_CSE_SEC_ACP_005_RET() {
	...
	@Test
	@Tag("TP_oneM2M_CSE_SEC_ACP_005_UPD")
	void TP_oneM2M_CSE_SEC_ACP_005_UPD() {
	...
	@Test
	@Tag("TP_oneM2M_CSE_SEC_ACP_005_DEL")
	void TP_oneM2M_CSE_SEC_ACP_005_DEL() {
