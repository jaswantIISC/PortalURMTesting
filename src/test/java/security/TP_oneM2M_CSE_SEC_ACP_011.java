...
@Tag("TP_oneM2M_CSE_SEC_ACP_011")
public class TP_oneM2M_CSE_SEC_ACP_011 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_SEC_ACP_011_CRE")
	void TP_oneM2M_CSE_SEC_ACP_011_CRE() {
		...
		assertEquals(M2MStatus.CREATED.getOnem2mStatusCode(), ciCreateRes.getResponseStatusCode());
	...
	@Test
	@Tag("TP_oneM2M_CSE_SEC_ACP_011_RET")
	void TP_oneM2M_CSE_SEC_ACP_011_RET() {
	...
	@Test
	@Tag("TP_oneM2M_CSE_SEC_ACP_011_UPD")
	void TP_oneM2M_CSE_SEC_ACP_011_UPD() {
		...
		AccessControlRule acr = new AccessControlRule();
		acr.setAccessControlOriginators(Arrays.asList(TestingParams.ADMIN_AE_ID, TestingParams.GENERAL_ADN_AE_ID));
		acr.setAccessControlOperations(BigInteger.valueOf(AccessControlOperations.CR_UP_DE.getValue()));
		...
		OneM2MResponse aeUpdateRes = contUpdate.updateContainerLabel(Arrays.asList("UpdatedLabel"), cont.getResourceID(), TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
	...
	@Test
	@Tag("TP_oneM2M_CSE_SEC_ACP_011_DEL")
	void TP_oneM2M_CSE_SEC_ACP_011_DEL() {
