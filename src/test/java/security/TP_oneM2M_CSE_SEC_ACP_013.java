...
@Tag("TP_oneM2M_CSE_SEC_ACP_013")
public class TP_oneM2M_CSE_SEC_ACP_013 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_SEC_ACP_013_CRE")
	void TP_oneM2M_CSE_SEC_ACP_013_CRE() {
	...
	@Test
	@Tag("TP_oneM2M_CSE_SEC_ACP_013_RET")
	void TP_oneM2M_CSE_SEC_ACP_013_RET() {
	...
	@Test
	@Tag("TP_oneM2M_CSE_SEC_ACP_013_UPD")
	void TP_oneM2M_CSE_SEC_ACP_013_UPD() {
		...
		OneM2MResponse aeUpdateRes = aeUpdate.updateLabel(Arrays.asList("UpdatedLabel"), TestingParams.GENERAL_ADN_AE_ID, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
	...
	@Test
	@Tag("TP_oneM2M_CSE_SEC_ACP_013_DEL")
	void TP_oneM2M_CSE_SEC_ACP_013_DEL() {
