...
@Tag("TP_oneM2M_CSE_SEC_ACP_CRE_001")
public class TP_oneM2M_CSE_SEC_ACP_CRE_001 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_SEC_ACP_CRE_001_ACR")
	void TP_oneM2M_CSE_SEC_ACP_CRE_001_ACR() {
		...
		assertTrue(acp.getPrivileges().getAccessControlRule() != null && acp.getPrivileges().getAccessControlRule().size() == 2);
