...
@Tag("TP_oneM2M_CSE_SEC_ACP_CRE_003")
public class TP_oneM2M_CSE_SEC_ACP_CRE_003 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_SEC_ACP_CRE_003_ACR")
	void TP_oneM2M_CSE_SEC_ACP_CRE_003_ACR() {
		...
		OneM2MResponse acpResponse = acpCreate.createWithCustomPrivilegeSelfPrivilege(null, setOfACRs, TestingParams.GENERAL_ADN_AE_ID, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		...
		assertTrue(acp.getSelfPrivileges().getAccessControlRule() != null && acp.getSelfPrivileges().getAccessControlRule().size() == 2);
