...
@Tag("TP_oneM2M_CSE_SEC_ACP_CRE_004")
public class TP_oneM2M_CSE_SEC_ACP_CRE_004 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_SEC_ACP_CRE_004_ACR")
	void TP_oneM2M_CSE_SEC_ACP_CRE_004_ACR() {
		...
		SetOfAcrs selfPriv = new SetOfAcrs();
		selfPriv.setAccessControlRule(Arrays.asList());
		OneM2MResponse acpResponse = acpCreate.createWithCustomPrivilegeSelfPrivilege(setOfACRs, selfPriv, TestingParams.GENERAL_ADN_AE_ID, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.BAD_REQUEST.getOnem2mStatusCode(), acpResponse.getResponseStatusCode());
