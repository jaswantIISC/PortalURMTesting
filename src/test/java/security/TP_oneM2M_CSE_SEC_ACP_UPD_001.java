...
@Tag("TP_oneM2M_CSE_SEC_ACP_UPD_001")
public class TP_oneM2M_CSE_SEC_ACP_UPD_001 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_SEC_ACP_UPD_001_ACR")
	void TP_oneM2M_CSE_SEC_ACP_UPD_001_ACR() {
		...
		AE aeUpdated = (AE) aeUpdateRes.getPrimitiveContent().getAny();
		assertTrue(aeUpdated.getAccessControlPolicyIDs().contains(acp2.getResourceID()));
