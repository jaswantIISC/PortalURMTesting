...
@Tag("TP_oneM2M_CSE_SUB_CRE_002")
public class TP_oneM2M_CSE_SUB_CRE_002 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_SUB_CRE_002_CONT")
	void TP_oneM2M_CSE_SUB_CRE_002_CONT() {
		...
		OneM2MResponse container1Response = contCreate.createWithACPIDS(Arrays.asList(acp.getResourceID()), TestingParams.GENERAL_ADN_AE_ID, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		...
		OneM2MResponse subResponse = subCreate.createWithCreator(TestingParams.GENERAL_ADN_AE_ID, container1ResourceId, TestingParams.GENERAL_ADN_AE_ID, TestingParams.getSecurityParams(TestingParams.GENERAL_ADN_AE_ID));
		assertEquals(M2MStatus.ACCESS_DENIED.getOnem2mStatusCode(), subResponse.getResponseStatusCode());
		// INITIAL STATE ENDS
