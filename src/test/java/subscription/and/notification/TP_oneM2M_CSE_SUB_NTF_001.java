...
@Tag("TP_oneM2M_CSE_SUB_NTF_001")
public class TP_oneM2M_CSE_SUB_NTF_001 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_SUB_NTF_001_CONT")
	void TP_oneM2M_CSE_SUB_NTF_001_CONT() {
		...
		assertEquals(M2MStatus.SUBSCRIPTION_CREATOR_HAS_NO_PRIVILEGE.getOnem2mStatusCode(), subResponse.getResponseStatusCode());
