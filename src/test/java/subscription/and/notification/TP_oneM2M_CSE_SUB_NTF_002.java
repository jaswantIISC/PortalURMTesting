...
@Tag("TP_oneM2M_CSE_SUB_NTF_002")
public class TP_oneM2M_CSE_SUB_NTF_002 {
	...
	@Test
	@Tag("TP_oneM2M_CSE_SUB_NTF_002_CONT")
	void TP_oneM2M_CSE_SUB_NTF_002_CONT() {
		...
		assertEquals(M2MStatus.SUBSCRIPTION_HOST_HAS_NO_PRIVILEGE.getOnem2mStatusCode(), subResponse.getResponseStatusCode());
